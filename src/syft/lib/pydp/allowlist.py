...
] = "pydp.algorithms.laplacian._bounded_algorithms.BoundedMean"


# SECTION - BoundedMean allowed functions

allowlist["pydp.algorithms.laplacian.BoundedMean.quick_result"] = UnionGenerator[
    "syft.lib.python.Float", "syft.lib.python.Int"
]
...
allowlist["pydp.algorithms.laplacian.BoundedMean.result"] = UnionGenerator[
    "syft.lib.python.Float", "syft.lib.python.Int"
]
