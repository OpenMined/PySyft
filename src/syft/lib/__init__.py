...
from ..lib.syfertext import create_syfertext_ast
...
def create_lib_ast() -> Globals:
    ...
    syfertext_ast = create_syfertext_ast()    
    ...
    lib_ast.add_attr(attr_name="syfertext", attr=syfertext_ast.attrs["syfertext"])    
