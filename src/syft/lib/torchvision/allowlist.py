...
ret = [
    ...
    "syft.lib.tensor.IntegerTensor",
    "syft.lib.numpy.ndarray",
]

allowlist["torchvision.transforms.Normalize.mean"] = (
    ret[0] or ret[1] or ret[2] or ret[3] or ret[4] or ret[5]
)

allowlist["torchvision.transforms.Normalize.std"] = (
    ret[0] or ret[1] or ret[2] or ret[3] or ret[4] or ret[5]
)
