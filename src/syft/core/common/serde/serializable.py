...
def get_protobuf(cls: type) -> (set, set):
    ...
    def check_type(s) -> SerdeTypes:
        ...
        valid_serde = not_abstract and object2proto_implemented and proto2object_implemented and \
                      get_schema_implemented
    ...
    def serialize(
        ...
        if to_json or to_binary or to_hex:
            ...
            if to_json:
                ...
                blob = json_format.MessageToJson(JsonMessage(obj_type= type(self).__qualname__,
                                                     content=blob))
