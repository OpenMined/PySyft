...
mbp_cpu = CPU(num_cores=6, num_threads_per_core=1, clock_speed=2.2, architecture=CpuArchitectureTypes.x86_64)
macbook_pro_15in_2018 = DeviceType(name="Macbook Pro (15-inch, 2018)",
