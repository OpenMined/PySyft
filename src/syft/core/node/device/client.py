...
from .service import CreateVMResponseMessage
...
class DeviceClient(Client):
    ...
    def create_vm(self, settings: dict) -> CreateVMResponseMessage:
        ...
        reply_msg = self.send_immediate_msg_with_reply(msg=msg)
