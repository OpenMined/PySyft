...
_PROTOUID = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='obj_type', full_name='tutorial.ProtoUID.obj_type', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='value', full_name='tutorial.ProtoUID.value', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='as_wrapper', full_name='tutorial.ProtoUID.as_wrapper', index=2,
...
_PROTOOBJECTWITHID = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='id', full_name='tutorial.ProtoObjectWithId.id', index=0,
...
ProtoUID = _reflection.GeneratedProtocolMessageType('ProtoUID', (_message.Message,), {
