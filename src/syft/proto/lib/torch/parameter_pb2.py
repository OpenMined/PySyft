...
_PARAMETERPROTO.fields_by_name['tensor'].message_type = proto_dot_lib_dot_torch_dot_tensor__pb2._TENSORDATA
_PARAMETERPROTO.fields_by_name['grad'].message_type = proto_dot_lib_dot_torch_dot_tensor__pb2._TENSORDATA
