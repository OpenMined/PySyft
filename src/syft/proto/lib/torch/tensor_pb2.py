...
_TENSORPROTOS = _descriptor.Descriptor(
    name="TensorProtos",
    full_name="syft.lib.torch.TensorProtos",
    filename=None,
    file=DESCRIPTOR,
    containing_type=None,
    fields=[
        _descriptor.FieldDescriptor(
            name="protos",
            full_name="syft.lib.torch.TensorProtos.protos",
            index=0,
            number=1,
            type=11,
            cpp_type=10,
...
_TENSORPROTO = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="dims",
            full_name="syft.lib.torch.TensorProto.dims",
            index=0,
            number=1,
            type=3,
            cpp_type=2,
        ...
        _descriptor.FieldDescriptor(
            name="data_type",
            full_name="syft.lib.torch.TensorProto.data_type",
            index=1,
            number=2,
            type=14,
            cpp_type=8,
        ...
        _descriptor.FieldDescriptor(
            name="float_data",
            full_name="syft.lib.torch.TensorProto.float_data",
            index=2,
            number=3,
            type=2,
            cpp_type=6,
        ...
        _descriptor.FieldDescriptor(
            name="int32_data",
            full_name="syft.lib.torch.TensorProto.int32_data",
            index=3,
            number=4,
            type=5,
            cpp_type=1,
        ...
        _descriptor.FieldDescriptor(
            name="byte_data",
            full_name="syft.lib.torch.TensorProto.byte_data",
            index=4,
            number=5,
            type=12,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="string_data",
            full_name="syft.lib.torch.TensorProto.string_data",
            index=5,
            number=6,
            type=12,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="double_data",
            full_name="syft.lib.torch.TensorProto.double_data",
            index=6,
            number=7,
            type=1,
            cpp_type=5,
        ...
        _descriptor.FieldDescriptor(
            name="int64_data",
            full_name="syft.lib.torch.TensorProto.int64_data",
            index=7,
            number=8,
            type=3,
            cpp_type=2,
...
TensorProtos = _reflection.GeneratedProtocolMessageType(
    ...
    (_message.Message,),
    {
        ...
        # @@protoc_insertion_point(class_scope:syft.lib.torch.TensorProtos)
    },
)
