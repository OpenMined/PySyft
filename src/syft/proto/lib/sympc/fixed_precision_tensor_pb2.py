...
# source: proto/lib/sympc/fixed_precision_tensor.proto
...
DESCRIPTOR = _descriptor.FileDescriptor(
    name="proto/lib/sympc/fixed_precision_tensor.proto",
    package="syft.lib.sympc",
    syntax="proto3",
    serialized_options=None,
    create_key=_descriptor._internal_create_key,
    serialized_pb=b'\n,proto/lib/sympc/fixed_precision_tensor.proto\x12\x0esyft.lib.sympc\x1a%proto/core/common/common_object.proto\x1a\x1cproto/lib/torch/tensor.proto\x1a\x1bproto/lib/python/dict.proto"j\n\x14\x46ixedPrecisionTensor\x12+\n\x06tensor\x18\x01 \x01(\x0b\x32\x1b.syft.lib.torch.TensorProto\x12%\n\x06\x63onfig\x18\x02 \x01(\x0b\x32\x15.syft.lib.python.Dictb\x06proto3',
    dependencies=[
...
_FIXEDPRECISIONTENSOR = _descriptor.Descriptor(
    ...
    full_name="syft.lib.sympc.FixedPrecisionTensor",
    filename=None,
    file=DESCRIPTOR,
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="tensor",
            full_name="syft.lib.sympc.FixedPrecisionTensor.tensor",
            index=0,
            number=1,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="config",
            full_name="syft.lib.sympc.FixedPrecisionTensor.config",
            index=1,
            number=2,
            type=11,
            cpp_type=10,
...
FixedPrecisionTensor = _reflection.GeneratedProtocolMessageType(
    ...
    (_message.Message,),
    {
        ...
        "__module__": "proto.lib.sympc.fixed_precision_tensor_pb2"
        # @@protoc_insertion_point(class_scope:syft.lib.sympc.FixedPrecisionTensor)
    },
)
