...
_RANGE = _descriptor.Descriptor(
    ...
    fields=[
        ...
        _descriptor.FieldDescriptor(
            name="has_start",
            full_name="syft.lib.python.Range.has_start",
            index=3,
            number=4,
            type=8,
            cpp_type=7,
        ...
        _descriptor.FieldDescriptor(
            name="has_stop",
            full_name="syft.lib.python.Range.has_stop",
            index=4,
            number=5,
            type=8,
            cpp_type=7,
        ...
        _descriptor.FieldDescriptor(
            name="has_step",
            full_name="syft.lib.python.Range.has_step",
            index=5,
            number=6,
            type=8,
            cpp_type=7,
