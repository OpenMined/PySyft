...
DESCRIPTOR = _descriptor.FileDescriptor(
    ...
    serialized_pb=b'\n\x1bproto/lib/python/dict.proto\x12\x0fsyft.lib.python\x1a%proto/core/common/common_object.proto\x1a#proto/core/store/store_object.proto"X\n\x04\x44ict\x12-\n\x04\x64\x61ta\x18\x01 \x03(\x0b\x32\x1f.syft.core.store.StorableObject\x12!\n\x02id\x18\x02 \x01(\x0b\x32\x15.syft.core.common.UIDb\x06proto3',
    dependencies=[
...
_DICT = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="data",
            full_name="syft.lib.python.Dict.data",
            index=0,
            number=1,
            type=11,
            cpp_type=10,
