...
_LIST = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='data', full_name='syft.lib.python.List.data', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='id', full_name='syft.lib.python.List.id', index=1,
...
_LIST.fields_by_name['data'].message_type = proto_dot_core_dot_store_dot_store__object__pb2._STORABLEOBJECT
_LIST.fields_by_name['id'].message_type = proto_dot_core_dot_common_dot_common__object__pb2._UID
