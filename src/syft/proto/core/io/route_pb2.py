...
from syft.proto.core.io import connection_pb2 as proto_dot_core_dot_io_dot_connection__pb2
...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  ,
  dependencies=[proto_dot_core_dot_io_dot_location__pb2.DESCRIPTOR,proto_dot_core_dot_io_dot_connection__pb2.DESCRIPTOR,])
...
_SOLOROUTE = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='destination', full_name='syft.core.io.SoloRoute.destination', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='connection', full_name='syft.core.io.SoloRoute.connection', index=1,
...
_SOLOROUTE.fields_by_name['destination'].message_type = proto_dot_core_dot_io_dot_location__pb2._SPECIFICLOCATION
_SOLOROUTE.fields_by_name['connection'].message_type = proto_dot_core_dot_io_dot_connection__pb2._VIRTUALCLIENTCONNECTION
DESCRIPTOR.message_types_by_name['SoloRoute'] = _SOLOROUTE
_sym_db.RegisterFileDescriptor(DESCRIPTOR)

SoloRoute = _reflection.GeneratedProtocolMessageType('SoloRoute', (_message.Message,), {
