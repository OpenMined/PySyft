...
_SPECIFICLOCATION = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='id', full_name='syft.core.io.SpecificLocation.id', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='name', full_name='syft.core.io.SpecificLocation.name', index=1,
...
_SPECIFICLOCATION.fields_by_name['id'].message_type = proto_dot_core_dot_common_dot_common__object__pb2._UID
DESCRIPTOR.message_types_by_name['SpecificLocation'] = _SPECIFICLOCATION
_sym_db.RegisterFileDescriptor(DESCRIPTOR)

SpecificLocation = _reflection.GeneratedProtocolMessageType('SpecificLocation', (_message.Message,), {
