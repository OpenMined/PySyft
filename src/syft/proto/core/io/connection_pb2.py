...
_VIRTUALSERVERCONNECTION = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='node', full_name='syft.core.io.VirtualServerConnection.node', index=0,
...
_VIRTUALCLIENTCONNECTION = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='server', full_name='syft.core.io.VirtualClientConnection.server', index=0,
      number=1, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_VIRTUALSERVERCONNECTION.fields_by_name['node'].message_type = proto_dot_core_dot_io_dot_address__pb2._ADDRESS
_VIRTUALCLIENTCONNECTION.fields_by_name['server'].message_type = _VIRTUALSERVERCONNECTION
...
VirtualServerConnection = _reflection.GeneratedProtocolMessageType('VirtualServerConnection', (_message.Message,), {
...
VirtualClientConnection = _reflection.GeneratedProtocolMessageType('VirtualClientConnection', (_message.Message,), {
