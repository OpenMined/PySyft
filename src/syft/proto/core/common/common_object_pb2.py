...
_COMMONOBJECT = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='uid_object', full_name='syft.core.common.CommonObject.uid_object', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='object_with_id_object', full_name='syft.core.common.CommonObject.object_with_id_object', index=1,
...
CommonObject = _reflection.GeneratedProtocolMessageType('CommonObject', (_message.Message,), {
