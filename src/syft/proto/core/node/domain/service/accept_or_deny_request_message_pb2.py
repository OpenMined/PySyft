...
_ACCEPTORDENYREQUESTMESSAGE = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='msg_id', full_name='syft.core.node.domain.service.AcceptOrDenyRequestMessage.msg_id', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='address', full_name='syft.core.node.domain.service.AcceptOrDenyRequestMessage.address', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='request_id', full_name='syft.core.node.domain.service.AcceptOrDenyRequestMessage.request_id', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='accept', full_name='syft.core.node.domain.service.AcceptOrDenyRequestMessage.accept', index=3,
...
_ACCEPTORDENYREQUESTMESSAGE.fields_by_name['msg_id'].message_type = proto_dot_core_dot_common_dot_common__object__pb2._UID
_ACCEPTORDENYREQUESTMESSAGE.fields_by_name['address'].message_type = proto_dot_core_dot_io_dot_address__pb2._ADDRESS
_ACCEPTORDENYREQUESTMESSAGE.fields_by_name['request_id'].message_type = proto_dot_core_dot_common_dot_common__object__pb2._UID
DESCRIPTOR.message_types_by_name['AcceptOrDenyRequestMessage'] = _ACCEPTORDENYREQUESTMESSAGE
_sym_db.RegisterFileDescriptor(DESCRIPTOR)

AcceptOrDenyRequestMessage = _reflection.GeneratedProtocolMessageType('AcceptOrDenyRequestMessage', (_message.Message,), {
