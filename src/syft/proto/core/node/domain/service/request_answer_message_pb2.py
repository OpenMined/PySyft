...
_REQUESTANSWERMESSAGE = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='request_id', full_name='syft.core.node.domain.service.RequestAnswerMessage.request_id', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='address', full_name='syft.core.node.domain.service.RequestAnswerMessage.address', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='reply_to', full_name='syft.core.node.domain.service.RequestAnswerMessage.reply_to', index=2,
...
_REQUESTANSWERMESSAGE.fields_by_name['request_id'].message_type = proto_dot_core_dot_common_dot_common__object__pb2._UID
_REQUESTANSWERMESSAGE.fields_by_name['address'].message_type = proto_dot_core_dot_io_dot_address__pb2._ADDRESS
_REQUESTANSWERMESSAGE.fields_by_name['reply_to'].message_type = proto_dot_core_dot_io_dot_address__pb2._ADDRESS
DESCRIPTOR.message_types_by_name['RequestAnswerMessage'] = _REQUESTANSWERMESSAGE
_sym_db.RegisterFileDescriptor(DESCRIPTOR)

RequestAnswerMessage = _reflection.GeneratedProtocolMessageType('RequestAnswerMessage', (_message.Message,), {
