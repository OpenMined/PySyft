...
_REQUESTMESSAGE = _descriptor.Descriptor(
    ...
    fields=[
        ...
        _descriptor.FieldDescriptor(
            name="request_name",
            full_name="syft.core.node.domain.service.RequestMessage.request_name",
            index=2,
            number=3,
            type=9,
            cpp_type=9,
