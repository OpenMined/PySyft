...
_GARBAGECOLLECTOBJECTACTION = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='id_at_location', full_name='syft.core.node.common.action.GarbageCollectObjectAction.id_at_location', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='address', full_name='syft.core.node.common.action.GarbageCollectObjectAction.address', index=1,
...
_GARBAGECOLLECTOBJECTACTION.fields_by_name['id_at_location'].message_type = proto_dot_core_dot_common_dot_common__object__pb2._UID
_GARBAGECOLLECTOBJECTACTION.fields_by_name['address'].message_type = proto_dot_core_dot_io_dot_address__pb2._ADDRESS
DESCRIPTOR.message_types_by_name['GarbageCollectObjectAction'] = _GARBAGECOLLECTOBJECTACTION
_sym_db.RegisterFileDescriptor(DESCRIPTOR)

GarbageCollectObjectAction = _reflection.GeneratedProtocolMessageType('GarbageCollectObjectAction', (_message.Message,), {
