...
_RUNCLASSMETHODACTION_KWARGSENTRY = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='key', full_name='syft.core.node.common.action.RunClassMethodAction.KwargsEntry.key', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='value', full_name='syft.core.node.common.action.RunClassMethodAction.KwargsEntry.value', index=1,
...
_RUNCLASSMETHODACTION = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='path', full_name='syft.core.node.common.action.RunClassMethodAction.path', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='_self', full_name='syft.core.node.common.action.RunClassMethodAction._self', index=1,
      number=2, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='args', full_name='syft.core.node.common.action.RunClassMethodAction.args', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='kwargs', full_name='syft.core.node.common.action.RunClassMethodAction.kwargs', index=3,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='id_at_location', full_name='syft.core.node.common.action.RunClassMethodAction.id_at_location', index=4,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='address', full_name='syft.core.node.common.action.RunClassMethodAction.address', index=5,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='msg_id', full_name='syft.core.node.common.action.RunClassMethodAction.msg_id', index=6,
...
_RUNCLASSMETHODACTION_KWARGSENTRY.fields_by_name['value'].message_type = proto_dot_core_dot_pointer_dot_pointer__pb2._POINTER
_RUNCLASSMETHODACTION_KWARGSENTRY.containing_type = _RUNCLASSMETHODACTION
_RUNCLASSMETHODACTION.fields_by_name['_self'].message_type = proto_dot_core_dot_pointer_dot_pointer__pb2._POINTER
_RUNCLASSMETHODACTION.fields_by_name['args'].message_type = proto_dot_core_dot_pointer_dot_pointer__pb2._POINTER
_RUNCLASSMETHODACTION.fields_by_name['kwargs'].message_type = _RUNCLASSMETHODACTION_KWARGSENTRY
_RUNCLASSMETHODACTION.fields_by_name['id_at_location'].message_type = proto_dot_core_dot_common_dot_common__object__pb2._UID
_RUNCLASSMETHODACTION.fields_by_name['address'].message_type = proto_dot_core_dot_io_dot_address__pb2._ADDRESS
_RUNCLASSMETHODACTION.fields_by_name['msg_id'].message_type = proto_dot_core_dot_common_dot_common__object__pb2._UID
DESCRIPTOR.message_types_by_name['RunClassMethodAction'] = _RUNCLASSMETHODACTION
_sym_db.RegisterFileDescriptor(DESCRIPTOR)

RunClassMethodAction = _reflection.GeneratedProtocolMessageType('RunClassMethodAction', (_message.Message,), {
