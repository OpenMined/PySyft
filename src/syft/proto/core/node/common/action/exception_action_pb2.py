...
_EXCEPTIONMESSAGE = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='msg_id', full_name='syft.core.node.common.service.ExceptionMessage.msg_id', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='address', full_name='syft.core.node.common.service.ExceptionMessage.address', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='msg_id_causing_exception', full_name='syft.core.node.common.service.ExceptionMessage.msg_id_causing_exception', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='exception_type', full_name='syft.core.node.common.service.ExceptionMessage.exception_type', index=3,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='exception_msg', full_name='syft.core.node.common.service.ExceptionMessage.exception_msg', index=4,
...
_EXCEPTIONMESSAGE.fields_by_name['msg_id'].message_type = proto_dot_core_dot_common_dot_common__object__pb2._UID
_EXCEPTIONMESSAGE.fields_by_name['address'].message_type = proto_dot_core_dot_io_dot_address__pb2._ADDRESS
_EXCEPTIONMESSAGE.fields_by_name['msg_id_causing_exception'].message_type = proto_dot_core_dot_common_dot_common__object__pb2._UID
