...
_OBJECTSEARCHPERMISSIONUPDATEMESSAGE = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='msg_id', full_name='syft.core.node.common.service.ObjectSearchPermissionUpdateMessage.msg_id', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='address', full_name='syft.core.node.common.service.ObjectSearchPermissionUpdateMessage.address', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='target_verify_key', full_name='syft.core.node.common.service.ObjectSearchPermissionUpdateMessage.target_verify_key', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='target_object_id', full_name='syft.core.node.common.service.ObjectSearchPermissionUpdateMessage.target_object_id', index=3,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='add_instead_of_remove', full_name='syft.core.node.common.service.ObjectSearchPermissionUpdateMessage.add_instead_of_remove', index=4,
...
_OBJECTSEARCHPERMISSIONUPDATEMESSAGE.fields_by_name['msg_id'].message_type = proto_dot_core_dot_common_dot_common__object__pb2._UID
_OBJECTSEARCHPERMISSIONUPDATEMESSAGE.fields_by_name['address'].message_type = proto_dot_core_dot_io_dot_address__pb2._ADDRESS
_OBJECTSEARCHPERMISSIONUPDATEMESSAGE.fields_by_name['target_object_id'].message_type = proto_dot_core_dot_common_dot_common__object__pb2._UID
DESCRIPTOR.message_types_by_name['ObjectSearchPermissionUpdateMessage'] = _OBJECTSEARCHPERMISSIONUPDATEMESSAGE
_sym_db.RegisterFileDescriptor(DESCRIPTOR)

ObjectSearchPermissionUpdateMessage = _reflection.GeneratedProtocolMessageType('ObjectSearchPermissionUpdateMessage', (_message.Message,), {
