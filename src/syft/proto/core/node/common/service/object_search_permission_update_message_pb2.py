...
_ACCEPTORDENYREQUESTMESSAGE = _descriptor.Descriptor(
    ...
    full_name="syft.core.node.common.service.AcceptOrDenyRequestMessage",
    filename=None,
    file=DESCRIPTOR,
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="msg_id",
            full_name="syft.core.node.common.service.AcceptOrDenyRequestMessage.msg_id",
            index=0,
            number=1,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="address",
            full_name="syft.core.node.common.service.AcceptOrDenyRequestMessage.address",
            index=1,
            number=2,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name="syft.core.node.common.service.AcceptOrDenyRequestMessage.target_verify_key",
            index=2,
            number=3,
            type=12,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name="syft.core.node.common.service.AcceptOrDenyRequestMessage.target_object_id",
            index=3,
            number=4,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name="syft.core.node.common.service.AcceptOrDenyRequestMessage.add_instead_of_remove",
            index=4,
            number=5,
            type=8,
            cpp_type=7,
...
AcceptOrDenyRequestMessage = _reflection.GeneratedProtocolMessageType(
    ...
    (_message.Message,),
    {
        ...
        # @@protoc_insertion_point(class_scope:syft.core.node.common.service.AcceptOrDenyRequestMessage)
    },
)
