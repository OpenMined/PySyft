...
_REPRMESSAGE = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='msg_id', full_name='syft.core.node.common.service.ReprMessage.msg_id', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='address', full_name='syft.core.node.common.service.ReprMessage.address', index=1,
...
_REPRMESSAGE.fields_by_name['msg_id'].message_type = proto_dot_core_dot_common_dot_common__object__pb2._UID
_REPRMESSAGE.fields_by_name['address'].message_type = proto_dot_core_dot_io_dot_address__pb2._ADDRESS
DESCRIPTOR.message_types_by_name['ReprMessage'] = _REPRMESSAGE
_sym_db.RegisterFileDescriptor(DESCRIPTOR)

ReprMessage = _reflection.GeneratedProtocolMessageType('ReprMessage', (_message.Message,), {
