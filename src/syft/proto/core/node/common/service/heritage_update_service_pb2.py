...
_HERITAGEUPDATEMESSAGE = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='msg_id', full_name='syft.core.node.common.service.HeritageUpdateMessage.msg_id', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='address', full_name='syft.core.node.common.service.HeritageUpdateMessage.address', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='new_ancestry_address', full_name='syft.core.node.common.service.HeritageUpdateMessage.new_ancestry_address', index=2,
...
_HERITAGEUPDATEMESSAGE.fields_by_name['msg_id'].message_type = proto_dot_core_dot_common_dot_common__object__pb2._UID
_HERITAGEUPDATEMESSAGE.fields_by_name['address'].message_type = proto_dot_core_dot_io_dot_address__pb2._ADDRESS
_HERITAGEUPDATEMESSAGE.fields_by_name['new_ancestry_address'].message_type = proto_dot_core_dot_io_dot_address__pb2._ADDRESS
DESCRIPTOR.message_types_by_name['HeritageUpdateMessage'] = _HERITAGEUPDATEMESSAGE
_sym_db.RegisterFileDescriptor(DESCRIPTOR)

HeritageUpdateMessage = _reflection.GeneratedProtocolMessageType('HeritageUpdateMessage', (_message.Message,), {
