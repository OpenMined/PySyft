...
_OBJECTSEARCHMESSAGE = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='msg_id', full_name='syft.core.node.common.service.ObjectSearchMessage.msg_id', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='address', full_name='syft.core.node.common.service.ObjectSearchMessage.address', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='reply_to', full_name='syft.core.node.common.service.ObjectSearchMessage.reply_to', index=2,
...
_OBJECTSEARCHREPLYMESSAGE = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='msg_id', full_name='syft.core.node.common.service.ObjectSearchReplyMessage.msg_id', index=0,
      number=1, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='address', full_name='syft.core.node.common.service.ObjectSearchReplyMessage.address', index=1,
      number=2, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='results', full_name='syft.core.node.common.service.ObjectSearchReplyMessage.results', index=2,
...
_OBJECTSEARCHMESSAGE.fields_by_name['msg_id'].message_type = proto_dot_core_dot_common_dot_common__object__pb2._UID
_OBJECTSEARCHMESSAGE.fields_by_name['address'].message_type = proto_dot_core_dot_io_dot_address__pb2._ADDRESS
_OBJECTSEARCHMESSAGE.fields_by_name['reply_to'].message_type = proto_dot_core_dot_io_dot_address__pb2._ADDRESS
_OBJECTSEARCHREPLYMESSAGE.fields_by_name['msg_id'].message_type = proto_dot_core_dot_common_dot_common__object__pb2._UID
_OBJECTSEARCHREPLYMESSAGE.fields_by_name['address'].message_type = proto_dot_core_dot_io_dot_address__pb2._ADDRESS
_OBJECTSEARCHREPLYMESSAGE.fields_by_name['results'].message_type = proto_dot_core_dot_pointer_dot_pointer__pb2._POINTER
...
ObjectSearchMessage = _reflection.GeneratedProtocolMessageType('ObjectSearchMessage', (_message.Message,), {
...
ObjectSearchReplyMessage = _reflection.GeneratedProtocolMessageType('ObjectSearchReplyMessage', (_message.Message,), {
