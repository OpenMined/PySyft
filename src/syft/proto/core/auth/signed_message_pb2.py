...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  ,
  dependencies=[proto_dot_core_dot_common_dot_common__object__pb2.DESCRIPTOR,google_dot_protobuf_dot_empty__pb2.DESCRIPTOR,])
...
_SIGNEDMESSAGE = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='msg_id', full_name='syft.core.auth.SignedMessage.msg_id', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='obj_type', full_name='syft.core.auth.SignedMessage.obj_type', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='signature', full_name='syft.core.auth.SignedMessage.signature', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='verify_key', full_name='syft.core.auth.SignedMessage.verify_key', index=3,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='message', full_name='syft.core.auth.SignedMessage.message', index=4,
...
_VERIFYALL = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='all', full_name='syft.core.auth.VerifyAll.all', index=0,
      number=1, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_SIGNEDMESSAGE.fields_by_name['msg_id'].message_type = proto_dot_core_dot_common_dot_common__object__pb2._UID
_VERIFYALL.fields_by_name['all'].message_type = google_dot_protobuf_dot_empty__pb2._EMPTY
...
VerifyAll = _reflection.GeneratedProtocolMessageType('VerifyAll', (_message.Message,), {
