...
class MemoryLimitPolicy(Policy):
    ...
    @syft.typecheck.type_hints
    def error_policy(self, stats: "syft.worker.worker_supervisor.stats.WorkerStats") -> None:
        raise MemoryError("Memory limit exceeded.")

    @syft.typecheck.type_hints
    def enforce_policy(self, stats: "syft.worker.worker_supervisor.stats.WorkerStats") -> None:
        pass
