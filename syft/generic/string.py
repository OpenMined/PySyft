...
class BuiltinTypeWrapper(abc.ABCMeta):
    ...
    def __new__(cls, clsname, bases, dct, wrapped_type: type):
    ...
    def _args_adaptor(self: object, args: Tuple[object]):
        """
    ...
    def _wrap_return_value(self, attr: str, value: object):
...
class String(AbstractObject, metaclass=BuiltinTypeWrapper, wrapped_type=str):
    def __init__(
        ...
        super(String, self).__init__(id=id, owner=owner, tags=tags, description=description)
