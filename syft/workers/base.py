...
class BaseWorker(AbstractWorker, ObjectStorage):
    ...
    def fetch_plan(
        ...
        plan.commands.update_worker_ids(location.id, self.id)

        # Might be useless now
        # if plan.state.state_ids:
        #     state_ids = []
        #     for state_id in plan.state.state_ids:
        #         if copy:
        ...
        #     plan.commands.update_ids(plan.state.state_ids, state_ids)
        #     plan.state.state_ids = state_ids
