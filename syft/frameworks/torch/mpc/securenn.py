...
def _random_common_value(max_value, field, *workers):
    """
...
def share_convert(a_sh):
    ...
    r = _random_common_value(L // 2, L, *workers)
    ...
    u_sh = _shares_of_zero(1, L - 1, crypto_provider, *workers)  # TODO: correct field
    ...
    # 6)
    eta_p = private_compare(x_bit_sh, r - 1, eta_pp)  # PC expects x_bit_sh in Zp where p=67
    # 7)
...
def maxpool_deriv(x_sh):
    ...
    r = _random_common_value(int(L / 2) - 1, L, alice, bob)
