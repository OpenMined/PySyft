...
class FloatTensor():
    ...
    def addmm(self, x, y):
        """Performs a matrix multiplication of the matrices 'x' and 'y', the
        caller matrix 'self' is added to the final result.
    ...
    def batchify(self, dim, batch_size):
        return self.controller.params_func(cmd_func=self.cmd, name="batchify",
                                           params=[dim, batch_size],
    ...
    def split(self, split_size_or_sections, dim=0):
        ...
        if isinstance(split_size_or_sections, int):
            return self.controller.params_func(cmd_func=self.cmd, name="split_by_size",
                                               params=[split_size_or_sections, dim], return_type='FloatTensor_list')
        ...
        return self.controller.params_func(cmd_func=self.cmd, name="split_by_sections",
                                           params=split_size_or_sections + [dim], return_type='FloatTensor_list')
