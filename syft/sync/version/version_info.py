...
class VersionInfo(BaseModel):
    ...
    def current(cls) -> "VersionInfo":
        ...
        try:
            ...
            install_source = get_syft_install_source()
        except Exception as e:
            logger = logging.getLogger(__name__)
            logger.debug(f"Could not detect syft install source: {e}")

        return cls(
            syft_client_version=SYFT_VERSION,
            min_supported_syft_client_version=MIN_SUPPORTED_SYFT_VERSION,
