...
def _print_client_kwarg_warning() -> None:
    print(
        ...
        "   ✅ Correct:  sy.resolve_dataset_files_path('ocean_water_quality')\n"
        "   ❌ Wrong:    sy.resolve_dataset_files_path('ocean_water_quality', client=client)"
    )
...
def _print_dataset_files_warning() -> None:
    print(
        ...
        "        sy.resolve_dataset_files_path('<dataset_name>') and re-run %%writefile.\n\n"
        "   ✅ Correct:  sy.resolve_dataset_files_path('ocean_water_quality')\n"
