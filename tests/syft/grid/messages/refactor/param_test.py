...
new_messages = [
    ...
    {
        "message": ("GetAssociationRequests", association_messages),
        "request_content": {},
        "response_content": {
    ...
    {
        "message": ("ReceiveAssociationRequest", association_messages),
        "request_content": {},
        "response_content": {},
    },
    {
        "message": ("RespondAssociationRequest", association_messages),
        "request_content": {"association_request_id": "87564178", "status": "accept"},
        "response_content": {"msg": "Response registered status_codefully!"},
    },
    {
        "message": ("SendAssociationRequest", association_messages),
    ...
    # dataset_messages
    {
        "message": ("CreateDataset", dataset_messages),
        "request_content": {
    ...
    {
        "message": ("GetDatasets", dataset_messages),
        "request_content": {},
        "response_content": {
            "workers": {
                "626sadaf631": {
    ...
    {
        "message": ("UpdateDataset", dataset_messages),
        "request_content": {
            "dataset": ["<tensor_id>", "<tensor_id>", "<tensor_id>", "<tensor_id>"],
            "description": "Dataset Description",
            "tags": ["#x", "#data-sample"],
    ...
    # group_messages
    {
        "message": ("CreateGroup", group_messages),
        "request_content": {
    ...
    {
        "message": ("GetGroups", group_messages),
        "request_content": {},
        "response_content": {
        "groups": {
                "626sadaf631": {
    ...
    {
        "message": ("UpdateGroup", group_messages),
        "request_content":  {
            "group-id": "eqw9e4a5d846",
            "group-name": "Brain diseases group",
            "members": ["user-id1", "user-id2", "user-id3"],
    ...
    # infra_messages
    {
        "message": ("CreateWorker", infra_messages),
        "request_content": {
            "settings": {
    ...
    {
        "message": ("GetWorkers", infra_messages),
        "request_content": {},
        "response_content": {
            "workers": {
                "626sadaf631": {
    ...
    {
        "message": ("UpdateWorker", infra_messages),
        "request_content": {
            "worker-id": "eqw9e4a5d846",
            "settings": {
    ...
    # role_messages
    {
        "message": ("CreateRole", role_messages),
        "request_content": {
            "name": "Role Sample",
    ...
    {
        "message": ("GetRoles", role_messages),
        "request_content": {},
        "response_content": {
            "workers": {
                "626sadaf631": {
    ...
    {
        "message": ("UpdateRole", role_messages),
        "request_content": {
            "role_id": "9a4f9dasd6",
            "name": "Role Sample",
            "can_triage_results": True,
    ...
    # setup_messages
    {
        "message": ("CreateInitialSetUp", setup_messages),
        "request_content": {
            "settings": {
    ...
    {
        "message": ("GetSetUp", setup_messages),
        "request_content": {},
        "response_content": {
            "settings": {
                "cloud-admin-token": "d84we35ad3a1d59a84sd9",
    ...
    # tensor_messages
    {
        "message": ("CreateTensor", tensor_messages),
        "request_content": {
            "tensor": [1, 2, 3, 4, 5, 6],
    ...
    {
        "message": ("GetTensors", tensor_messages),
        "request_content": {},
        "response_content":  {
            "workers": {
                "626sadaf631": {
    ...
    {
        "message": ("UpdateTensor", tensor_messages),
        "request_content": {
            "tensor_id": "546a4d51",
            "tensor": [1, 2, 3, 4, 5, 6],
            "description": "Tensor description",
    ...
    # request_messages
    {
        "message": ("CreateRequest", request_messages),
        "request_content": {
    ...
    {
        "message": ("GetRequests", request_messages),
        "request_content": {},
        "response_content": {
            "workers": {
                "626sadaf631": {
    ...
    {
        "message": ("UpdateRequest", request_messages),
        "request_content": {
            "request_id": "546a4d51",
            "dataset-id": "68a465aer3adf",
            "user-id": "user-id7",
