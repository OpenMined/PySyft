...
class TestVersionMismatchCheck:
    ...
    @patch("syft_client.sync.login_utils.sys.exit")
    @patch("syft_client.sync.login_utils.delete_remote_syftbox")
    @patch("syft_client.sync.login_utils.delete_local_syftbox")
    @patch("syft_client.sync.login_utils._prompt_mismatch", return_value="3")
    @patch("syft_client.sync.login_utils._read_remote_version")
    @patch("syft_client.sync.login_utils.read_local_version")
...
class TestPromptWithoutATerminal:
    ...
    @patch("syft_client.sync.login_utils.sys.stdin")
    def test_no_terminal_keeps_data_and_continues(self, mock_stdin):
        ...
        from syft_client.sync.login_utils import _prompt_mismatch
