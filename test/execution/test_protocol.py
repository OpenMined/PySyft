...
def test_execution_with_communications(workers):
    ...
    assert len(protocol.role_assignments.assignments["role1"][0]._protocol_placeholders) == 3
    assert len(protocol.role_assignments.assignments["role2"][0]._protocol_placeholders) == 3
