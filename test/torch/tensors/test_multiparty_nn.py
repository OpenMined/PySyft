...
def test_private_compare(workers):
    ...
    x_bits = securenn.decompose(torch.tensor([3, 3])).share(alice, bob, charlie, crypto_provider=james).child
...
def test_share_convert(workers):
    ...
    tensorA = torch.tensor([10, 20, 30]).share(alice, bob, charlie,
                                                        crypto_provider=james, field=2**60).child
...
def test_msb(workers):
    ...
    tensorA = torch.tensor([-10, 0, 10]).share(alice, bob, charlie,
                                                        crypto_provider=james, field=2**60 - 1).child
...
def test_division(workers):
    ...
    tensorA = torch.tensor([[0, 10, 10, 20, 20]]).share(alice, bob, charlie, crypto_provider=james).child
    tensorB = torch.tensor([[1, 2, 3, 4, 5]]).share(alice, bob, charlie, crypto_provider=james).child
...
def test_maxpool(workers):
    ...
    tensorA = torch.tensor([[0, 1, 8, 3, 4]]).share(alice, bob, charlie, crypto_provider=james).child
...
def test_maxpool_deriv(workers):
    ...
    tensorA = torch.tensor([[0, 1, 8, 3]]).share(alice, bob, charlie, crypto_provider=james, field=2**60).child
