...
def test__str__():
    ...
    crt = t.fix_precision(field_type="int100", precision_fractional=0, storage="crt")
...
def test_eq():
    ...
    crt_a = t_a.fix_precision(field_type="int100", precision_fractional=0, storage="crt")
    crt_b = t_b.fix_precision(field_type="int100", precision_fractional=0, storage="crt")
    crt_c = t_c.fix_precision(field_type="int100", precision_fractional=0, storage="crt")
...
def test_share_and_get(workers):
    ...
    t = torch.tensor([1, 2])
    crt = t.fix_precision(field_type="int100", precision_fractional=0, storage="crt")
    copy = t.fix_precision(field_type="int100", precision_fractional=0, storage="crt")
