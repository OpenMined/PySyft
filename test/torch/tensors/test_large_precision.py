...
def test_large_prec(workers):
    ...
    enlarged = x.large_prec(internal_type=torch.int16, virtual_prec=256)
...
def test_add():
    ...
    lpt1 = x1.large_prec(internal_type=internal_type, virtual_prec=virtual_prec)
    lpt2 = x2.large_prec(internal_type=internal_type, virtual_prec=virtual_prec)
    result = lpt1 + lpt2
