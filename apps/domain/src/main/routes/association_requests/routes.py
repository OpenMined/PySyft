...
def reply_association_request():
    # status_code, response_body = error_handler(
    #   route_logic, ReplyAssociationRequestMessage
    # )
...
def get_all_association_requests():
    # status_code, response_body = error_handler(
    #   route_login, GetAllAssociationRequestsMessage
    # )
...
def get_specific_association_requests(association_request_id):
    status_code, response_body = error_handler(
        route_logic, GetAssociationRequestMessage
    )
