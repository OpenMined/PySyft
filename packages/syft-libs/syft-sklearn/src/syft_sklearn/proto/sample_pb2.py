...
DESCRIPTOR = _descriptor.FileDescriptor(
    ...
    serialized_pb=b'\n\x12proto/sample.proto\x12\x07sklearn\x1a\x1dproto/lib/python/string.proto",\n\x03Msg\x12%\n\x04name\x18\x01 \x01(\x0b\x32\x17.syft.lib.python.Stringb\x06proto3',
    dependencies=[
...
Msg = _reflection.GeneratedProtocolMessageType(
    ...
    (_message.Message,),
    {
        ...
        # @@protoc_insertion_point(class_scope:sklearn.Msg)
    },
)
