...
# source: proto/logistic_model.proto
...
DESCRIPTOR = _descriptor.FileDescriptor(
    name="proto/logistic_model.proto",
    package="sklearn",
    syntax="proto3",
    serialized_options=None,
    create_key=_descriptor._internal_create_key,
    serialized_pb=b'\n\x1aproto/logistic_model.proto\x12\x07sklearn\x1a%proto/core/common/common_object.proto\x1a\x1bproto/lib/python/dict.proto"S\n\x08Logistic\x12!\n\x02id\x18\x01 \x01(\x0b\x32\x15.syft.core.common.UID\x12$\n\x05model\x18\x02 \x01(\x0b\x32\x15.syft.lib.python.Dictb\x06proto3',
    dependencies=[
...
_LOGISTIC = _descriptor.Descriptor(
    ...
    fields=[
        ...
        _descriptor.FieldDescriptor(
            name="model",
            full_name="sklearn.Logistic.model",
            index=1,
            number=2,
            type=11,
            cpp_type=10,
...
Logistic = _reflection.GeneratedProtocolMessageType(
    ...
    (_message.Message,),
    {
        ...
        "__module__": "proto.logistic_model_pb2"
        # @@protoc_insertion_point(class_scope:sklearn.Logistic)
    },
)
