...
try:
    ...
    ret = obj.decode_rows()
    type_sklearn_externals__arff_LODData_decode_rows = (
    ...
    print(
        "❌ sklearn.externals._arff.LODData.decode_rows: Return unavailable"
    )  # noqa E501
...
try:
    obj = class_constructor()  # noqa F821
    ret = obj.encode_data()
    type_sklearn_externals__arff_LODData_encode_data = (
        getattr(ret, "__module__", "none") + "." + ret.__class__.__name__
    )
    ...
    print(
        "❌ sklearn.externals._arff.LODData.encode_data: Return unavailable"
    )  # noqa E501
    print("  Please fix this return type code until there is no exception")
    print("  Error:", e)
