...
try:
    ...
    type_sklearn_utils__estimator_html_repr__VisualBlock__sk_visual_block_ = (
    ...
    print(
        "❌ sklearn.utils._estimator_html_repr._VisualBlock._sk_visual_block_: Return unavailable"
    )  # noqa E501
