...
try:
    ...
    ret = obj.plot()
    type_sklearn_metrics__plot_roc_curve_RocCurveDisplay_plot = (
        getattr(ret, "__module__", "none") + "." + ret.__class__.__name__
    )
    print(
        "✅ sklearn.metrics._plot.roc_curve.RocCurveDisplay.plot: ", type(ret)
    )  # noqa E501
except Exception as e:
    type_sklearn_metrics__plot_roc_curve_RocCurveDisplay_plot = "_syft_missing"
    print(
        "❌ sklearn.metrics._plot.roc_curve.RocCurveDisplay.plot: Return unavailable"
    )  # noqa E501
