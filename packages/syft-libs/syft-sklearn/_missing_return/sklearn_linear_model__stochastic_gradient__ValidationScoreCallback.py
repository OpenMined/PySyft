...
try:
    ...
    ret = obj.__call__()
    type_sklearn_linear_model__stochastic_gradient__ValidationScoreCallback___call__ = (
    ...
    print(
        "❌ sklearn.linear_model._stochastic_gradient._ValidationScoreCallback.__call__: Return unavailable"
    )  # noqa E501
