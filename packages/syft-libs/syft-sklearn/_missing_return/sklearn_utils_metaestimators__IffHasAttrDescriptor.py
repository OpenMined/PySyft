...
try:
    ...
    ret = obj.__get__()
    type_sklearn_utils_metaestimators__IffHasAttrDescriptor___get__ = (
        getattr(ret, "__module__", "none") + "." + ret.__class__.__name__
    )
    print(
        "✅ sklearn.utils.metaestimators._IffHasAttrDescriptor.__get__: ", type(ret)
    )  # noqa E501
except Exception as e:
    type_sklearn_utils_metaestimators__IffHasAttrDescriptor___get__ = "_syft_missing"
    print(
        "❌ sklearn.utils.metaestimators._IffHasAttrDescriptor.__get__: Return unavailable"
    )  # noqa E501
