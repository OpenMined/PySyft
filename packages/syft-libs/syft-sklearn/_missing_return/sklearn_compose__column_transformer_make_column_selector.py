...
try:
    ...
    ret = obj.__call__()
    type_sklearn_compose__column_transformer_make_column_selector___call__ = (
    ...
    print(
        "❌ sklearn.compose._column_transformer.make_column_selector.__call__: Return unavailable"
    )  # noqa E501
