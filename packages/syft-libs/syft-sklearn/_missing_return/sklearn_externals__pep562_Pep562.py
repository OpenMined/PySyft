...
try:
    ...
    ret = obj.__dir__()
    type_sklearn_externals__pep562_Pep562___dir__ = (
...
try:
    obj = class_constructor()  # noqa F821
    ret = obj.__getattr__()
    type_sklearn_externals__pep562_Pep562___getattr__ = (
        getattr(ret, "__module__", "none") + "." + ret.__class__.__name__
    )
    ...
    print(
        "❌ sklearn.externals._pep562.Pep562.__getattr__: Return unavailable"
    )  # noqa E501
    print("  Please fix this return type code until there is no exception")
    print("  Error:", e)
