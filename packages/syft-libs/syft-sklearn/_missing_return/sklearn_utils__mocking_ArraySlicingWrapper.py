...
try:
    ...
    ret = obj.__getitem__()
    type_sklearn_utils__mocking_ArraySlicingWrapper___getitem__ = (
        getattr(ret, "__module__", "none") + "." + ret.__class__.__name__
    )
    print(
        "✅ sklearn.utils._mocking.ArraySlicingWrapper.__getitem__: ", type(ret)
    )  # noqa E501
except Exception as e:
    type_sklearn_utils__mocking_ArraySlicingWrapper___getitem__ = "_syft_missing"
    print(
        "❌ sklearn.utils._mocking.ArraySlicingWrapper.__getitem__: Return unavailable"
    )  # noqa E501
