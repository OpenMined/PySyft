...
try:
    ...
    ret = obj.split()
    type_sklearn_model_selection__search_successive_halving__SubsampleMetaSplitter_split = (
    ...
    print(
        "❌ sklearn.model_selection._search_successive_halving._SubsampleMetaSplitter.split: Return unavailable"
    )  # noqa E501
