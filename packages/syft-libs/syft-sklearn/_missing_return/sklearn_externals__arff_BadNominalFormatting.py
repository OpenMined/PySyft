...
try:
    ...
    ret = obj.__str__()
    type_sklearn_externals__arff_BadNominalFormatting___str__ = (
        getattr(ret, "__module__", "none") + "." + ret.__class__.__name__
    )
    print(
        "✅ sklearn.externals._arff.BadNominalFormatting.__str__: ", type(ret)
    )  # noqa E501
except Exception as e:
    type_sklearn_externals__arff_BadNominalFormatting___str__ = "_syft_missing"
    print(
        "❌ sklearn.externals._arff.BadNominalFormatting.__str__: Return unavailable"
    )  # noqa E501
