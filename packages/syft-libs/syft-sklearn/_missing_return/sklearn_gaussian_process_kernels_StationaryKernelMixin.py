...
try:
    ...
    type_sklearn_gaussian_process_kernels_StationaryKernelMixin_is_stationary = (
    ...
    print(
        "❌ sklearn.gaussian_process.kernels.StationaryKernelMixin.is_stationary: Return unavailable"
    )  # noqa E501
