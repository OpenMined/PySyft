...
try:
    ...
    ret = obj.biclusters_
    type_sklearn_base_BiclusterMixin_biclusters_ = (
...
try:
    ...
    ret = obj.get_indices()
    type_sklearn_base_BiclusterMixin_get_indices = (
        getattr(ret, "__module__", "none") + "." + ret.__class__.__name__
    )
...
try:
    obj = class_constructor()  # noqa F821
    ret = obj.get_shape()
    type_sklearn_base_BiclusterMixin_get_shape = (
        getattr(ret, "__module__", "none") + "." + ret.__class__.__name__
    )
...
try:
    ...
    type_sklearn_base_BiclusterMixin_get_submatrix = (
        getattr(ret, "__module__", "none") + "." + ret.__class__.__name__
    )
    ...
    print(
        "❌ sklearn.base.BiclusterMixin.get_submatrix: Return unavailable"
    )  # noqa E501
    print("  Please fix this return type code until there is no exception")
    print("  Error:", e)
