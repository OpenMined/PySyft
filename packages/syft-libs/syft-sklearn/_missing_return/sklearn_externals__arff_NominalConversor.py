...
try:
    ...
    ret = obj.__call__()
    type_sklearn_externals__arff_NominalConversor___call__ = (
        getattr(ret, "__module__", "none") + "." + ret.__class__.__name__
    )
    print(
        "✅ sklearn.externals._arff.NominalConversor.__call__: ", type(ret)
    )  # noqa E501
except Exception as e:
    type_sklearn_externals__arff_NominalConversor___call__ = "_syft_missing"
    print(
        "❌ sklearn.externals._arff.NominalConversor.__call__: Return unavailable"
    )  # noqa E501
