...
try:
    ...
    ret = obj.__call__()
    type_pandas_io_formats_css_CSSResolver___call__ = (
    getattr(ret, '__module__', None) + '.' + ret.__class__.__name__
        if getattr(ret, '__module__', None)
        else ret.__class__.__name__
        )
    print("✅ pandas.io.formats.css.CSSResolver.__call__:",
        type_pandas_io_formats_css_CSSResolver___call__)
except Exception as e:
    type_pandas_io_formats_css_CSSResolver___call__ = '_syft_missing'
    print('❌ pandas.io.formats.css.CSSResolver.__call__: Return unavailable')
