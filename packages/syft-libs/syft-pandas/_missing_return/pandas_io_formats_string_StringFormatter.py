...
try:
    ...
    print(
        "❌ pandas.io.formats.string.StringFormatter._adjusted_tr_col_num: Return unavailable"
    )
...
try:
    ...
    print(
        "❌ pandas.io.formats.string.StringFormatter._empty_info_line: Return unavailable"
    )
    print("  Please fix this return type code until there is no exception")
    print("  Error:", e)
...
try:
    ...
    print(
        "❌ pandas.io.formats.string.StringFormatter._need_to_wrap_around: Return unavailable"
    )
    print("  Please fix this return type code until there is no exception")
    print("  Error:", e)
