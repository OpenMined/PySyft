...
try:
    ...
    print(
        "❌ pandas.io.formats.latex.RowStringConverter._empty_info_line: Return unavailable"
    )
...
try:
    ...
    print(
        "❌ pandas.io.formats.latex.RowStringConverter._header_row_num: Return unavailable"
    )
    print("  Please fix this return type code until there is no exception")
    print("  Error:", e)
...
try:
    ...
    print(
        "❌ pandas.io.formats.latex.RowStringConverter.column_levels: Return unavailable"
    )
    print("  Please fix this return type code until there is no exception")
    print("  Error:", e)
...
try:
    ...
    print(
        "❌ pandas.io.formats.latex.RowStringConverter.header_levels: Return unavailable"
    )
    print("  Please fix this return type code until there is no exception")
    print("  Error:", e)
...
try:
    ...
    print(
        "❌ pandas.io.formats.latex.RowStringConverter.index_levels: Return unavailable"
    )
    print("  Please fix this return type code until there is no exception")
    print("  Error:", e)
