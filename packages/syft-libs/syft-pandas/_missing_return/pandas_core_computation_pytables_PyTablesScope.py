...
try:
    ...
    print(
        "❌ pandas.core.computation.pytables.PyTablesScope.full_scope: Return unavailable"
    )
...
try:
    ...
    print(
        "❌ pandas.core.computation.pytables.PyTablesScope.has_resolvers: Return unavailable"
    )
    print("  Please fix this return type code until there is no exception")
    print("  Error:", e)
...
try:
    ...
    print(
        "❌ pandas.core.computation.pytables.PyTablesScope.resolve: Return unavailable"
    )
    print("  Please fix this return type code until there is no exception")
    print("   Error:", e)
