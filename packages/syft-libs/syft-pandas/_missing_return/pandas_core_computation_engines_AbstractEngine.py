...
try:
    ...
    print(
        "❌ pandas.core.computation.engines.AbstractEngine._evaluate: Return unavailable"
    )
...
try:
    ...
    print(
        "❌ pandas.core.computation.engines.AbstractEngine._is_aligned: Return unavailable"
    )
    print("  Please fix this return type code until there is no exception")
    print("  Error:", e)
