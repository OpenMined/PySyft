...
try:
    ...
    print(
        "❌ pandas.core.groupby.ops.SeriesSplitter.__class_getitem__: Return unavailable"
    )
...
try:
    ...
    print(
        "❌ pandas.core.groupby.ops.SeriesSplitter.__init_subclass__: Return unavailable"
    )
    print("  Please fix this return type code until there is no exception")
    print("   Error:", e)
