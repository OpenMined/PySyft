...
try:
    ...
    print(
        "❌ pandas.io.formats.style_render.StylerRenderer._compute: Return unavailable"
    )
...
try:
    ...
    print(
        "❌ pandas.io.formats.style_render.StylerRenderer._translate: Return unavailable"
    )
    print("  Please fix this return type code until there is no exception")
    print("   Error:", e)
...
try:
    ...
    print(
        "❌ pandas.io.formats.style_render.StylerRenderer._translate_body: Return unavailable"
    )
    print("  Please fix this return type code until there is no exception")
    print("   Error:", e)
...
try:
    ...
    print(
        "❌ pandas.io.formats.style_render.StylerRenderer._translate_header: Return unavailable"
    )
    print("  Please fix this return type code until there is no exception")
    print("   Error:", e)
