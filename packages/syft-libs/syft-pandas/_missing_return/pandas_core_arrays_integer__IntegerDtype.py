...
# pandas.core.arrays.integer._IntegerDtype._can_hold_na
try:
    obj = class_constructor()
    ret = obj._can_hold_na
    type_pandas_core_arrays_integer__IntegerDtype__can_hold_na = (
    ...
    type_pandas_core_arrays_integer__IntegerDtype__can_hold_na = "_syft_missing"
    print("❌ pandas.core.arrays.integer._IntegerDtype._can_hold_na: Return unavailable")
