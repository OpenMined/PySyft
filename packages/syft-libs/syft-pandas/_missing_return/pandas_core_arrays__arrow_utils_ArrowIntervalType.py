...
try:
    ...
    print(
        "❌ pandas.core.arrays._arrow_utils.ArrowIntervalType.__arrow_ext_deserialize__: Return unavailable"
    )
...
try:
    ...
    print(
        "❌ pandas.core.arrays._arrow_utils.ArrowIntervalType.__arrow_ext_serialize__: Return unavailable"
    )
    print("  Please fix this return type code until there is no exception")
    print("   Error:", e)
...
try:
    ...
    print(
        "❌ pandas.core.arrays._arrow_utils.ArrowIntervalType.__eq__: Return unavailable"
    )
    print("  Please fix this return type code until there is no exception")
    print("   Error:", e)
...
try:
    ...
    print(
        "❌ pandas.core.arrays._arrow_utils.ArrowIntervalType.__hash__: Return unavailable"
    )
    print("  Please fix this return type code until there is no exception")
    print("   Error:", e)
...
try:
    ...
    print(
        "❌ pandas.core.arrays._arrow_utils.ArrowIntervalType.closed: Return unavailable"
    )
    print("  Please fix this return type code until there is no exception")
    print("  Error:", e)
...
try:
    ...
    print(
        "❌ pandas.core.arrays._arrow_utils.ArrowIntervalType.subtype: Return unavailable"
    )
    print("  Please fix this return type code until there is no exception")
    print("  Error:", e)
...
try:
    ...
    print(
        "❌ pandas.core.arrays._arrow_utils.ArrowIntervalType.to_pandas_dtype: Return unavailable"
    )
    print("  Please fix this return type code until there is no exception")
    print("   Error:", e)
