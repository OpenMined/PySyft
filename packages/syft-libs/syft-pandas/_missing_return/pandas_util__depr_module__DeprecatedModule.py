...
try:
    ...
    print(
        "❌ pandas.util._depr_module._DeprecatedModule.__getattr__: Return unavailable"
    )
...
try:
    ...
    print(
        "❌ pandas.util._depr_module._DeprecatedModule._import_deprmod: Return unavailable"
    )
    print("  Please fix this return type code until there is no exception")
    print("   Error:", e)
