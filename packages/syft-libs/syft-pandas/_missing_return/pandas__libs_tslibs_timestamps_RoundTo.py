...
try:
    ...
    print(
        "❌ pandas._libs.tslibs.timestamps.RoundTo.NEAREST_HALF_EVEN: Return unavailable"
    )
    print("  Please fix this return type code until there is no exception")
    print("  Error:", e)
...
try:
    ...
    print(
        "❌ pandas._libs.tslibs.timestamps.RoundTo.NEAREST_HALF_MINUS_INFTY: Return unavailable"
    )
    print("  Please fix this return type code until there is no exception")
    print("  Error:", e)
...
try:
    ...
    print(
        "❌ pandas._libs.tslibs.timestamps.RoundTo.NEAREST_HALF_PLUS_INFTY: Return unavailable"
    )
    print("  Please fix this return type code until there is no exception")
    print("  Error:", e)
