...
try:
    ...
    print(
        "❌ pandas.io.formats.html.NotebookFormatter.should_show_dimensions: Return unavailable"
    )
    print("  Please fix this return type code until there is no exception")
    print("  Error:", e)
...
try:
    ...
    print(
        "❌ pandas.io.formats.html.NotebookFormatter.show_col_idx_names: Return unavailable"
    )
    print("  Please fix this return type code until there is no exception")
    print("  Error:", e)
...
try:
    ...
    print(
        "❌ pandas.io.formats.html.NotebookFormatter.show_row_idx_names: Return unavailable"
    )
    print("  Please fix this return type code until there is no exception")
    print("  Error:", e)
