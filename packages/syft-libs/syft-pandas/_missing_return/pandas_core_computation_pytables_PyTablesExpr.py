...
try:
    ...
    print(
        "❌ pandas.core.computation.pytables.PyTablesExpr.__call__: Return unavailable"
    )
...
try:
    ...
    print(
        "❌ pandas.core.computation.pytables.PyTablesExpr.assigner: Return unavailable"
    )
    print("  Please fix this return type code until there is no exception")
    print("  Error:", e)
...
try:
    ...
    print(
        "❌ pandas.core.computation.pytables.PyTablesExpr.evaluate: Return unavailable"
    )
    print("  Please fix this return type code until there is no exception")
    print("   Error:", e)
