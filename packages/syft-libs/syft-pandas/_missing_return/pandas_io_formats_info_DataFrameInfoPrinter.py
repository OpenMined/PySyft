...
try:
    ...
    print(
        "❌ pandas.io.formats.info.DataFrameInfoPrinter.exceeds_info_cols: Return unavailable"
    )
    print("  Please fix this return type code until there is no exception")
    print("  Error:", e)
...
try:
    ...
    print(
        "❌ pandas.io.formats.info.DataFrameInfoPrinter.exceeds_info_rows: Return unavailable"
    )
    print("  Please fix this return type code until there is no exception")
    print("  Error:", e)
