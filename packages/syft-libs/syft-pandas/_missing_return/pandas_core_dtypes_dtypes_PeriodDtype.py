...
def class_constructor(*args, **kwargs):
    obj = pandas.core.dtypes.dtypes.PeriodDtype()
    return obj
...
try:
    obj = class_constructor()
    ret = obj._parse_dtype_strict()
    type_pandas_core_dtypes_dtypes_PeriodDtype__parse_dtype_strict = (
    getattr(ret, '__module__', None) + '.' + ret.__class__.__name__
        if getattr(ret, '__module__', None)
        else ret.__class__.__name__
        )
    print("✅ pandas.core.dtypes.dtypes.PeriodDtype._parse_dtype_strict:",
        type_pandas_core_dtypes_dtypes_PeriodDtype__parse_dtype_strict)
except Exception as e:
    type_pandas_core_dtypes_dtypes_PeriodDtype__parse_dtype_strict = '_syft_missing'
    print('❌ pandas.core.dtypes.dtypes.PeriodDtype._parse_dtype_strict: Return unavailable')
    print("  Please fix this return type code until there is no exception")
    print('   Error:', e)
