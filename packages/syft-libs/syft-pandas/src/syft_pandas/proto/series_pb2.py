...
_PANDASSERIES = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="series",
            full_name="pandas.PandasSeries.series",
            index=0,
            number=1,
            type=12,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name="pandas.PandasSeries.decompressed_size",
            index=1,
            number=2,
            type=4,
            cpp_type=4,
...
PandasSeries = _reflection.GeneratedProtocolMessageType(
    ...
    (_message.Message,),
    {
        ...
        "__module__": "proto.series_pb2"
        # @@protoc_insertion_point(class_scope:pandas.PandasSeries)
    },
)
