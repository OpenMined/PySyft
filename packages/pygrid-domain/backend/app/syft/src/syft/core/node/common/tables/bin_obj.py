...
def BinObject(TableBase: DeclarativeMeta) -> DeclarativeMeta:
    """Initialize the BinObject Table and attached it to the TableBase"""

    class BinObject(TableBase):  # type: ignore
