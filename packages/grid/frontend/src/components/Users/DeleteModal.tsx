  ...
  return (
    <Modal show={show} onClose={onClose}>
      <div className="flex w-full justify-center">
        ...
        <Text>
          If deleted the selected user(s) will have their accounts removed from your domain node and will have all
          pending requests closed.
        </Text>
        <div className="flex space-x-3">
          <Button variant="primary" className="bg-error-500" size="sm" onClick={() => trigger(userIds)}>
            Delete User
          </Button>
