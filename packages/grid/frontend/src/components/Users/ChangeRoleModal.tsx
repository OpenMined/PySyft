    ...
    <Modal show={show} onClose={onClose} className="max-w-3xl">
      <div className="col-span-full">
        ...
        <Text className="mt-4" as="p">
          Permissions for a user are set by their assigned role. These permissions are used for
          managing the domain. To review and customize the default set of roles visit the{' '}
