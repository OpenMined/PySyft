...
const datasetFileRequirements: DatasetRequirementsList = [
  {term: 'tags', description: 'Contains a list of tags, one tag per line, written in the format #tag'},
  {
    term: 'description',
    description:
...
export function DatasetRequirementsList() {
  return (
    <>
      ...
      <p>
        PyGrid currently accepts tarball files <Highlight>.tar.gz</Highlight>. It is advised to add the following files
        to your archive: <Highlight>tags</Highlight>, <Highlight>description</Highlight> and{' '}
        <Highlight>manifest</Highlight>. These files should be saved without any extensions and only contain plain text.
        The following is a quick description of each file:
      </p>
      ...
      <p>
        All users with <Highlight className="uppercase">Can upload data</Highlight> are allowed to create new datasets
        in the domain.
      </p>
    </>
  )
