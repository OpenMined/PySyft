...
export const NormalButton = forwardRef<HTMLButtonElement, GridButton>(
  function NormalButton(props, ref) {
...
export function ClosePanelButton(props: GridButton) {
  return (
    <NormalButton {...props} type="button" className="flex-shrink-0 mt-auto" />
  )
}
