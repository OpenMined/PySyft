<script>
    import { Modal , Button, Helper } from 'flowbite-svelte';
    ...
    $: changeModal = !(!modalActiveList[0] && !modalActiveList[1] && !modalActiveList[2] && !modalActiveList[3] && !modalActiveList[4] && !modalActiveList[5] )
    ...
    async function submitUserChanges() {
            ...
            let institution = ( document.getElementById('team') ) ?  document.getElementById('team').value : null
...
<Modal bind:open={userModal} placement="top-center" size="md" class="w-full" style={unfocusModal}>
        ...
        <form class="space-y-3 px-3" style='padding-bottom: 10%;'>
          <div class='space-y-3' style='padding-bottom: 5%;'>
              ...
              <div class='space-y-1' style='display:flex;flex-direction:column'>
                ...
                <button style='text-align: left' on:click={ () => {modalActiveList[0] = !modalActiveList[0]}}><span class='font-roboto small change-link-text'>Change name</span></button>
              </div>
              <div class='space-y-1' style='display:flex;flex-direction:column'>
                <span class='font-bold small'>Team</span>
                <span class='font-roboto small'>{user_info.institution}</span>
                <button style='text-align: left' on:click={ () => {modalActiveList[1] = !modalActiveList[1]}}><span  class='font-roboto small change-link-text'>Change Team</span></button>
              </div>
              <div class='space-y-1' style='display:flex;flex-direction:column'>
                <span class='font-bold small'>Website</span>
                <span class='font-roboto small'>{user_info.website}</span>
                <button style='text-align: left' on:click={ () => {modalActiveList[2] = !modalActiveList[2]}}><span class='font-roboto small change-link-text'>Change website</span></button>
              </div>
          </div>
          <div class='space-y-3' style='padding-bottom: 5%;'>
              ...
              <div class='space-y-1' style='display:flex;flex-direction:column'>
                ...
                <button style='text-align: left' on:click={ () => {modalActiveList[3] = !modalActiveList[3]}}><span class='font-roboto small change-link-text' >Change Email</span></button>
              </div>
              <div class='space-y-1' style='display:flex;flex-direction:column'>
                <span class='font-bold small'>Password</span>
                <button style='text-align: left' on:click={ () => {modalActiveList[4] = !modalActiveList[4]}}><span class='font-roboto small change-link-text'>Change Password</span></button>
              </div>
          </div>
          ...
          <div class='space-y-2' style='display:flex;flex-direction:column'>
            ...
            <button style='text-align: left' on:click={ () => {modalActiveList[5] = !modalActiveList[5]}}><span  style='color: red;'>Delete Account</span></button>
          </div>
        </form>
      </div>
    </div>
  ...
  <Modal bind:open={modalActiveList[3]} placement="center" size="xs" class="w-full">
    ...
    <div class='space-x-3' style="display:flex;justify-content:right">
      <button on:click={ () => {modalActiveList[3] = !modalActiveList[3]}}> Cancel </button>
      <Button pill={true} on:click={ () => submitUserChanges() } color="dark">Confirm</Button>
    </div>
  </Modal>
  ...
  <Modal bind:open={modalActiveList[2]} placement="center" size="xs"  class="w-full">
    ...
    <div class='space-x-3' style="display:flex;justify-content:right">
      <button on:click={ () => {modalActiveList[2] = !modalActiveList[2]}}> Cancel </button>
      <Button pill={true} on:click={ () => submitUserChanges() } color="dark">Confirm</Button>
    </div>
  </Modal>
  ...
  <Modal bind:open={modalActiveList[1]} placement="center" size="xs" class="w-full">
    ...
    <div class='space-x-3' style="display:flex;justify-content:right">
      <button on:click={ () => {modalActiveList[1] = !modalActiveList[1]}}> Cancel </button>
      <Button pill={true} on:click={ () => submitUserChanges() } color="dark">Confirm</Button>
    </div>
  </Modal>
  <Modal bind:open={modalActiveList[4]} placement="center" size="xs" class="w-full">
    ...
    <FormControl placeholder="********" label="Password Confirmation" type='password' id="password-confirmation" required />
    
    <div class='space-x-3' style="display:flex;justify-content:right">
      <button on:click={ () => {modalActiveList[4] = !modalActiveList[4]}}> Cancel </button>
      <Button pill={true} on:click={ () => submitUserChanges() } color="dark">Confirm</Button>
    </div>
  </Modal>
  ...
  <Modal bind:open={modalActiveList[5]} placement="center" size="xs" class="w-full">
    <div style='display:flex; justify-content:center'>
      <div style='background-color: black; border-radius: 50%; width: 30px;height:30px;align-items:center;justify-content:center;display:flex'>
        <YellowWarn/>
      </div>
    </div>
    <h2>When you delete your user account all information relating to you will be deleted as well as any permissions and requests. If you are the domain owner the domain node will be deleted as well and will be closed to all users. To transfer ownership of a domain node before deleting your account you can follow the instructions here.</h2>
    <div class='space-x-3' style="display:flex;justify-content:center">
      <button on:click={ () => {modalActiveList[5] = !modalActiveList[5]}}> Cancel </button>
