...
const Tabs = forwardRef<HTMLDivElement, TabsProps>(function Tabs(
  ...
  return (
    <TabsContext.Provider
      value={{
        focusNext: handleNextEl,
        focusPrev: handlePrevEl,
        variant,
        onChange,
        size,
        align,
...
function Tab({ id, title, disabled, isActive }: TabProps) {
  ...
  const tabClasses = cn(
    [
      'relative top-0.5 font-roboto font-bold',
      variants[context.variant]?.default,
    ],
    isActive
