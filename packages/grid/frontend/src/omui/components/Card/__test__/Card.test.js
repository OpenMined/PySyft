...
describe('Render the Progress Card correctly', () => {
  test('Render the right footer with progress', () => {
    ...
    const progressDiv = cardFooter.getElementsByClassName('absolute h-1 to-primary-500')[0]
  ...
  test('Render the progress percentage value', () => {
    ...
    render(<Card data-testid="test-id" variant="progress" progress={randomValue} />)
