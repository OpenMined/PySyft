...
export const Template: Story<CardProps> = args => <Card {...args}>Content</Card>

const variants = ['coming', 'default', 'progress', 'completed'] as CardVariantProp[]
...
export default {
  ...
  argTypes: {
    ...
    srcImage: {
      defaultValue: 'https://images.unsplash.com/photo-1588892487050-67d92a5f4136',
      type: 'string',
    },
    progress: { defaultValue: 60, control: { type: 'range', min: 0, max: 100, step: 1 } },
    tags: {
