  ...
  return (
    <Modal show={show} onClose={onClose}>
      <div className="col-span-full text-center">
        ...
        />
        <H4 className="mt-3">
          {t('change-password-success-heading', 'settings')}
        </H4>
      </div>
    </Modal>
  )
  ...
  return (
    <Modal show={show} onClose={onClose}>
      <div className="col-span-full text-center">
        ...
        />
        <H4 className="mt-3">
          {t('account-delete-warning-heading', 'account')}
        </H4>
      </div>
  ...
  return (
    <Modal show={show} onClose={onClose}>
      <div className="col-span-full text-center">
        ...
        />
        <H4 className="mt-3">
          {t('account-delete-success-heading', 'account')}
        </H4>
      </div>
      <div className="col-span-full text-center mt-4">
...
export default function AccountSettings() {
  return (
    <Base>
      <TopContent
        heading={<Breadcrumbs path={t('settings-account', 'paths')} />}
      />
      <div className="col-span-9 mt-10">
        <Alert.Info
          alertStyle="topAccent"
          description={t('alert', 'account')}
        />
      </div>
