...
it('Test Float primitive serialization/deserialization', () => {
  ...
  const serializedPositiveMultipleDecimalFloat = serde.serialize(positiveMultipleDecimalFloat);
  const serializedNegativeMultipleDecimalFloat = serde.serialize(negativeMultipleDecimalFloat);
...
it('Test String primitive serialization/deserialization', () => {
  ...
  const serializedcomplexStringStructure = serde.serialize(complexStringStructure);
  ...
  expect(serde.deserialize(serializedcomplexStringStructure)).toBe(complexStringStructure);
});
...
it('Test List/Array primitive serialization/deserialization', () => {
  ...
  expect(serde.deserialize(serializedArrayOfArrays)).toStrictEqual(ArrayOfArrays);
});
