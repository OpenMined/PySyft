...
if [[ ("${INSTALL_OBLV_CLI}" == "true")  &&  ("${SERVICE_NAME}" == "backend"  ||  "${SERVICE_NAME}" == "celeryworker" ) ]]; then
    ...
    echo "Oblivious CLI not installed INSTALL_OBLV_CLI:${INSTALL_OBLV_CLI} , SERVICE_NAME:${SERVICE_NAME} "
fi
