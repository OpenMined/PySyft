...
class SyftMigrationRegistry:
    ...
    def register_transform(
        ...
        if klass_type_str not in cls.__object_version_registry__:
            raise Exception(f"{klass_type_str} is not yet registered.")

        available_versions = cls.__object_version_registry__[klass_type_str]
        ...
        if versions_exists:
            ...
            cls.__object_transform_registry__[klass_type_str][mapping_string] = method
