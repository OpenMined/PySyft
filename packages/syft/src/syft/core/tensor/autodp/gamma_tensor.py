...
class GammaTensor:
    ...
    def __mul__(self, other: Any) -> GammaTensor:
        ...
        # If the other Tensor is PhiTensor, we convert
        # it to a GammaTensor
        if isinstance(other, PhiTensor):
            other = other.gamma

        # If the other tensor is already a GammaTensor,
        # we multiply the child data, min_vals and max_vals
        if isinstance(other, GammaTensor):
            output_state[other.id] = other
            child = self.child * other.child
        ...
        # If the other tensor is not a DPTensor, we multiply the values
        # and keep the data_subjects the same
        else:
            child = self.child * other
