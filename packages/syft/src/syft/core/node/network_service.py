...
class NetworkServiceClass(NodeService):
    @staticmethod
    ...
    def process(
        ...
        """A single service to execute messages for the Network client.

        Args:
            node (NodeServiceInterface): Network service interface.
    ...
    def message_handler_types() -> list:
        registered_messages = NetworkMessageRegistry().get_registered_messages()
