...
from ..common.node_service.object_request.object_request_service import ObjectRequestServiceWithoutReply
...
class Domain(Node):
    ...
    def __init__(
        ...
        self.immediate_services_with_reply.append(ObjectRequestServiceWithoutReply)
