...
# from ....node.common.node_service.object_transfer.object_transfer_messages import (
#     SaveObjectMessage,
# )
...
#
# # TODO: don't remove - instead move this functionality back to
# # TODO: PyGrid where it belongs and then uncomment it.
...
#
#         _worker_obj = self.client.__class__(
#             credentials={},
#             url=self.client.conn.base_url,
#             conn_type=self.client.conn.__class__,
