...
_DATAMESSAGE = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='magic_header', full_name='syft.util.DataMessage.magic_header', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='obj_type', full_name='syft.util.DataMessage.obj_type', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='content', full_name='syft.util.DataMessage.content', index=2,
