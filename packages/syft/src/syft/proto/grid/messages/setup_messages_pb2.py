...
_CREATEINITIALSETUPRESPONSE = _descriptor.Descriptor(
    ...
    fields=[
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name="syft.grid.messages.CreateInitialSetUpResponse.service_response",
            index=1,
            number=3,
            type=9,
            cpp_type=9,
