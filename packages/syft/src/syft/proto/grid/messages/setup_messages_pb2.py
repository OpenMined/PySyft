...
_CREATEINITIALSETUPMESSAGE = _descriptor.Descriptor(
    ...
    fields=[
        ...
        _descriptor.FieldDescriptor(
            name="signing_key",
            full_name="syft.grid.messages.CreateInitialSetUpMessage.signing_key",
            index=8,
            number=9,
            type=12,
            cpp_type=9,
