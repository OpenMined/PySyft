...
_GETDATASETSRESPONSE = _descriptor.Descriptor(
    ...
    fields=[
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name="syft.grid.messages.GetDatasetsResponse.datasets_metadata",
            index=2,
            number=3,
            type=11,
            cpp_type=10,
