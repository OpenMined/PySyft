...
PublishScalarsAction = _reflection.GeneratedProtocolMessageType(
    ...
    (_message.Message,),
    {
        ...
        "__module__": "proto.core.node.domain.service.get_remaining_budget_pb2"
