...
_REQUESTMESSAGE = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='request_id', full_name='syft.core.node.domain.service.RequestMessage.request_id', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='object_id', full_name='syft.core.node.domain.service.RequestMessage.object_id', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='object_tags', full_name='syft.core.node.domain.service.RequestMessage.object_tags', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='request_description', full_name='syft.core.node.domain.service.RequestMessage.request_description', index=3,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='target_address', full_name='syft.core.node.domain.service.RequestMessage.target_address', index=4,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='owner_address', full_name='syft.core.node.domain.service.RequestMessage.owner_address', index=5,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='requester_verify_key', full_name='syft.core.node.domain.service.RequestMessage.requester_verify_key', index=6,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='timeout_secs', full_name='syft.core.node.domain.service.RequestMessage.timeout_secs', index=7,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='object_type', full_name='syft.core.node.domain.service.RequestMessage.object_type', index=8,
...
_REQUESTMESSAGE.fields_by_name['request_id'].message_type = proto_dot_core_dot_common_dot_common__object__pb2._UID
_REQUESTMESSAGE.fields_by_name['object_id'].message_type = proto_dot_core_dot_common_dot_common__object__pb2._UID
_REQUESTMESSAGE.fields_by_name['target_address'].message_type = proto_dot_core_dot_io_dot_address__pb2._ADDRESS
_REQUESTMESSAGE.fields_by_name['owner_address'].message_type = proto_dot_core_dot_io_dot_address__pb2._ADDRESS
