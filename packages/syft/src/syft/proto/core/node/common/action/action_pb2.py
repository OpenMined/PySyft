...
DESCRIPTOR = _descriptor.FileDescriptor(
    ...
    dependencies=[
        ...
        proto_dot_core_dot_node_dot_common_dot_action_dot_action__sequence__pb2.DESCRIPTOR,
    ],
)
...
_ACTION = _descriptor.Descriptor(
    ...
    fields=[
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name="syft.core.node.common.action.Action.action_sequence",
            index=9,
            number=11,
            type=11,
            cpp_type=10,
...
_ACTION.fields_by_name[
    ...
    proto_dot_core_dot_node_dot_common_dot_action_dot_action__sequence__pb2._ACTIONSEQUENCE
)
...
_ACTION.oneofs_by_name["action"].fields.append(
    _ACTION.fields_by_name["action_sequence"]
)
_ACTION.fields_by_name["action_sequence"].containing_oneof = _ACTION.oneofs_by_name[
    "action"
]
