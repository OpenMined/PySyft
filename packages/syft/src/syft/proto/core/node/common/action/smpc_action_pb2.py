...
# source: proto/core/node/common/action/smpc_action.proto
...
_SMPCACTION_KWARGSIDENTRY = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="key",
            full_name="syft.core.node.common.action.SMPCAction.KwargsIdEntry.key",
            index=0,
            number=1,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="value",
            full_name="syft.core.node.common.action.SMPCAction.KwargsIdEntry.value",
            index=1,
            number=2,
            type=11,
            cpp_type=10,
...
_SMPCACTION = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="name_action",
            full_name="syft.core.node.common.action.SMPCAction.name_action",
            index=0,
            number=1,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="self_id",
            full_name="syft.core.node.common.action.SMPCAction.self_id",
            index=1,
            number=2,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="args_id",
            full_name="syft.core.node.common.action.SMPCAction.args_id",
            index=2,
            number=3,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="kwargs_id",
            full_name="syft.core.node.common.action.SMPCAction.kwargs_id",
            index=3,
            number=4,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="id_at_location",
            full_name="syft.core.node.common.action.SMPCAction.id_at_location",
            index=4,
            number=6,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="address",
            full_name="syft.core.node.common.action.SMPCAction.address",
            index=5,
            number=7,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="msg_id",
            full_name="syft.core.node.common.action.SMPCAction.msg_id",
            index=6,
            number=8,
            type=11,
            cpp_type=10,
...
_SMPCACTION_KWARGSIDENTRY.fields_by_name[
    "value"
].message_type = proto_dot_core_dot_common_dot_common__object__pb2._UID
_SMPCACTION_KWARGSIDENTRY.containing_type = _SMPCACTION
_SMPCACTION.fields_by_name[
    "self_id"
].message_type = proto_dot_core_dot_common_dot_common__object__pb2._UID
_SMPCACTION.fields_by_name[
    "args_id"
...
SMPCAction = _reflection.GeneratedProtocolMessageType(
    "SMPCAction",
    (_message.Message,),
    {
        "KwargsIdEntry": _reflection.GeneratedProtocolMessageType(
            ...
            (_message.Message,),
            {
                ...
                "__module__": "proto.core.node.common.action.smpc_action_pb2"
