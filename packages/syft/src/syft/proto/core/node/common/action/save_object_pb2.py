...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  ,
  dependencies=[proto_dot_core_dot_store_dot_store__object__pb2.DESCRIPTOR,proto_dot_core_dot_io_dot_address__pb2.DESCRIPTOR,])
...
_SAVEOBJECTACTION = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='obj', full_name='syft.core.node.common.action.SaveObjectAction.obj', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='address', full_name='syft.core.node.common.action.SaveObjectAction.address', index=1,
