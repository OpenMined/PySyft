...
_GETENUMATTRIBUTEACTION = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='path', full_name='syft.core.node.common.action.GetEnumAttributeAction.path', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='id_at_location', full_name='syft.core.node.common.action.GetEnumAttributeAction.id_at_location', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='address', full_name='syft.core.node.common.action.GetEnumAttributeAction.address', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='msg_id', full_name='syft.core.node.common.action.GetEnumAttributeAction.msg_id', index=3,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='value_index', full_name='syft.core.node.common.action.GetEnumAttributeAction.value_index', index=4,
...
_GETENUMATTRIBUTEACTION.fields_by_name['id_at_location'].message_type = proto_dot_core_dot_common_dot_common__object__pb2._UID
_GETENUMATTRIBUTEACTION.fields_by_name['address'].message_type = proto_dot_core_dot_io_dot_address__pb2._ADDRESS
_GETENUMATTRIBUTEACTION.fields_by_name['msg_id'].message_type = proto_dot_core_dot_common_dot_common__object__pb2._UID
DESCRIPTOR.message_types_by_name['GetEnumAttributeAction'] = _GETENUMATTRIBUTEACTION
_sym_db.RegisterFileDescriptor(DESCRIPTOR)

GetEnumAttributeAction = _reflection.GeneratedProtocolMessageType('GetEnumAttributeAction', (_message.Message,), {
