...
_STORABLEOBJECT = _descriptor.Descriptor(
    ...
    oneofs=[
        _descriptor.OneofDescriptor(
            name="_data_type",
            full_name="syft.core.store.StorableObject._data_type",
            index=0,
            containing_type=None,
            create_key=_descriptor._internal_create_key,
            fields=[],
        ...
        _descriptor.OneofDescriptor(
            name="_data",
            full_name="syft.core.store.StorableObject._data",
            index=1,
            containing_type=None,
            create_key=_descriptor._internal_create_key,
            fields=[],
...
_STORABLEOBJECT.oneofs_by_name["_data_type"].fields.append(
    _STORABLEOBJECT.fields_by_name["data_type"]
)
_STORABLEOBJECT.fields_by_name[
    "data_type"
].containing_oneof = _STORABLEOBJECT.oneofs_by_name["_data_type"]
_STORABLEOBJECT.oneofs_by_name["_data"].fields.append(
    _STORABLEOBJECT.fields_by_name["data"]
)
_STORABLEOBJECT.fields_by_name[
    "data"
].containing_oneof = _STORABLEOBJECT.oneofs_by_name["_data"]
