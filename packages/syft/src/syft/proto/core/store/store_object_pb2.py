...
_STORABLEOBJECT = _descriptor.Descriptor(
    ...
    fields=[
        ...
        _descriptor.FieldDescriptor(
            name="name",
            full_name="syft.core.store.StorableObject.name",
            index=8,
            number=9,
            type=9,
            cpp_type=9,
