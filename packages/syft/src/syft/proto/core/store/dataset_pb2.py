...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  ,
  dependencies=[proto_dot_core_dot_common_dot_common__object__pb2.DESCRIPTOR,proto_dot_core_dot_store_dot_store__object__pb2.DESCRIPTOR,])
...
_DATASET = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='id', full_name='syft.core.store.Dataset.id', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='obj_type', full_name='syft.core.store.Dataset.obj_type', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='schematic_qualname', full_name='syft.core.store.Dataset.schematic_qualname', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='data', full_name='syft.core.store.Dataset.data', index=3,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='description', full_name='syft.core.store.Dataset.description', index=4,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='tags', full_name='syft.core.store.Dataset.tags', index=5,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='read_permissions', full_name='syft.core.store.Dataset.read_permissions', index=6,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='search_permissions', full_name='syft.core.store.Dataset.search_permissions', index=7,
...
_DATASET.fields_by_name['id'].message_type = proto_dot_core_dot_common_dot_common__object__pb2._UID
_DATASET.fields_by_name['data'].message_type = proto_dot_core_dot_store_dot_store__object__pb2._STORABLEOBJECT
