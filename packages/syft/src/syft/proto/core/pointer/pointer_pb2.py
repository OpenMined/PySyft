...
_POINTER.fields_by_name['id_at_location'].message_type = proto_dot_core_dot_common_dot_common__object__pb2._UID
_POINTER.fields_by_name['location'].message_type = proto_dot_core_dot_io_dot_address__pb2._ADDRESS
