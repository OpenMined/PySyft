...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  ,
  dependencies=[proto_dot_core_dot_node_dot_common_dot_action_dot_action__pb2.DESCRIPTOR,proto_dot_core_dot_pointer_dot_pointer__pb2.DESCRIPTOR,])
...
_PLAN_I2OMAPENTRY = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='key', full_name='syft.core.plan.Plan.I2oMapEntry.key', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='value', full_name='syft.core.plan.Plan.I2oMapEntry.value', index=1,
...
_PLAN = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='i2o_map', full_name='syft.core.plan.Plan.i2o_map', index=3,
  ...
  nested_types=[_PLAN_INPUTSENTRY, _PLAN_I2OMAPENTRY, ],
  enum_types=[
  ],
  serialized_options=None,
  is_extendable=False,
...
_PLAN_INPUTSENTRY.fields_by_name['value'].message_type = proto_dot_core_dot_pointer_dot_pointer__pb2._POINTER
...
_PLAN.fields_by_name['outputs'].message_type = proto_dot_core_dot_pointer_dot_pointer__pb2._POINTER
...
Plan = _reflection.GeneratedProtocolMessageType('Plan', (_message.Message,), {
  ...
  'I2oMapEntry' : _reflection.GeneratedProtocolMessageType('I2oMapEntry', (_message.Message,), {
