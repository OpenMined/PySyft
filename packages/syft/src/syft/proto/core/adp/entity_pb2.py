...
_ENTITY = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='name', full_name='syft.core.adp.Entity.name', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='id', full_name='syft.core.adp.Entity.id', index=1,
...
_ENTITY.fields_by_name['id'].message_type = proto_dot_core_dot_common_dot_common__object__pb2._UID
