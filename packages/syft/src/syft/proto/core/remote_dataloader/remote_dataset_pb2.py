...
_REMOTEDATASET = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='data_type', full_name='syft.core.node.common.remote_dataloader.RemoteDataset.data_type', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='path', full_name='syft.core.node.common.remote_dataloader.RemoteDataset.path', index=1,
...
_REMOTEDATALOADER = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='remote_dataset', full_name='syft.core.node.common.remote_dataloader.RemoteDataLoader.remote_dataset', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='batch_size', full_name='syft.core.node.common.remote_dataloader.RemoteDataLoader.batch_size', index=1,
...
RemoteDataset = _reflection.GeneratedProtocolMessageType('RemoteDataset', (_message.Message,), {
...
RemoteDataLoader = _reflection.GeneratedProtocolMessageType('RemoteDataLoader', (_message.Message,), {
