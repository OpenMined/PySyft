...
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _ITERABLE._serialized_end = 87
    _KVITERABLE._serialized_start = 89
    _KVITERABLE._serialized_end = 131
    _RECURSIVESERDE._serialized_start = 133
    _RECURSIVESERDE._serialized_end = 248
