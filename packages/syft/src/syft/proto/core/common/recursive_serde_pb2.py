...
_RECURSIVESERDE = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='fields_name', full_name='syft.core.common.RecursiveSerde.fields_name', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='fields_data', full_name='syft.core.common.RecursiveSerde.fields_data', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='fully_qualified_name', full_name='syft.core.common.RecursiveSerde.fully_qualified_name', index=2,
...
RecursiveSerde = _reflection.GeneratedProtocolMessageType('RecursiveSerde', (_message.Message,), {
