...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  ,
  dependencies=[proto_dot_lib_dot_torch_dot_tensor__pb2.DESCRIPTOR,proto_dot_lib_dot_python_dot_dict__pb2.DESCRIPTOR,])
...
_REPLICATEDSHAREDTENSOR = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='tensor', full_name='syft.lib.sympc.ReplicatedSharedTensor.tensor', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='config', full_name='syft.lib.sympc.ReplicatedSharedTensor.config', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='session_uuid', full_name='syft.lib.sympc.ReplicatedSharedTensor.session_uuid', index=2,
...
_REPLICATEDSHAREDTENSOR.fields_by_name['tensor'].message_type = proto_dot_lib_dot_torch_dot_tensor__pb2._TENSORPROTO
_REPLICATEDSHAREDTENSOR.fields_by_name['config'].message_type = proto_dot_lib_dot_python_dot_dict__pb2._DICT
DESCRIPTOR.message_types_by_name['ReplicatedSharedTensor'] = _REPLICATEDSHAREDTENSOR
_sym_db.RegisterFileDescriptor(DESCRIPTOR)

ReplicatedSharedTensor = _reflection.GeneratedProtocolMessageType('ReplicatedSharedTensor', (_message.Message,), {
