...
_BATCHENCODING = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='id', full_name='syft.lib.transformers.BatchEncoding.id', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='data', full_name='syft.lib.transformers.BatchEncoding.data', index=1,
...
_BATCHENCODING.fields_by_name['id'].message_type = proto_dot_core_dot_common_dot_common__object__pb2._UID
_BATCHENCODING.fields_by_name['data'].message_type = proto_dot_lib_dot_python_dot_dict__pb2._DICT
DESCRIPTOR.message_types_by_name['BatchEncoding'] = _BATCHENCODING
_sym_db.RegisterFileDescriptor(DESCRIPTOR)

BatchEncoding = _reflection.GeneratedProtocolMessageType('BatchEncoding', (_message.Message,), {
