...
_PANDASSERIES = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='series', full_name='syft.lib.pandas.PandasSeries.series', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='decompressed_size', full_name='syft.lib.pandas.PandasSeries.decompressed_size', index=1,
...
PandasSeries = _reflection.GeneratedProtocolMessageType('PandasSeries', (_message.Message,), {
