...
_TENSORPROTO = _descriptor.Descriptor(
  ...
  oneofs=[
    _descriptor.OneofDescriptor(
      name='_grad', full_name='syft.lib.torch.TensorProto._grad',
      index=0, containing_type=None,
      create_key=_descriptor._internal_create_key,
    fields=[]),
  ],
...
_TENSORPROTO.oneofs_by_name['_grad'].fields.append(
  _TENSORPROTO.fields_by_name['grad'])
_TENSORPROTO.fields_by_name['grad'].containing_oneof = _TENSORPROTO.oneofs_by_name['_grad']
