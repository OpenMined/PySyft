...
_PARAMETERPROTO = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='tensor', full_name='syft.lib.torch.ParameterProto.tensor', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='requires_grad', full_name='syft.lib.torch.ParameterProto.requires_grad', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='grad', full_name='syft.lib.torch.ParameterProto.grad', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='grad_sample', full_name='syft.lib.torch.ParameterProto.grad_sample', index=3,
  ...
  oneofs=[
    _descriptor.OneofDescriptor(
      name='_grad', full_name='syft.lib.torch.ParameterProto._grad',
      index=0, containing_type=None,
      create_key=_descriptor._internal_create_key,
    fields=[]),
    _descriptor.OneofDescriptor(
      name='_grad_sample', full_name='syft.lib.torch.ParameterProto._grad_sample',
...
_PARAMETERPROTO.fields_by_name['grad'].containing_oneof = _PARAMETERPROTO.oneofs_by_name['_grad']
_PARAMETERPROTO.oneofs_by_name['_grad_sample'].fields.append(
  _PARAMETERPROTO.fields_by_name['grad_sample'])
_PARAMETERPROTO.fields_by_name['grad_sample'].containing_oneof = _PARAMETERPROTO.oneofs_by_name['_grad_sample']
