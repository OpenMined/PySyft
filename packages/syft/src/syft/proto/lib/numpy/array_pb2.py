...
_NUMPYPROTO = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='arrow_data', full_name='syft.lib.numpy.NumpyProto.arrow_data', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='proto_data', full_name='syft.lib.numpy.NumpyProto.proto_data', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='dtype', full_name='syft.lib.numpy.NumpyProto.dtype', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='decompressed_size', full_name='syft.lib.numpy.NumpyProto.decompressed_size', index=3,
  ...
  oneofs=[
    _descriptor.OneofDescriptor(
      name='data', full_name='syft.lib.numpy.NumpyProto.data',
...
_NUMPYPROTO.fields_by_name['arrow_data'].containing_oneof = _NUMPYPROTO.oneofs_by_name['data']
_NUMPYPROTO.oneofs_by_name['data'].fields.append(
  _NUMPYPROTO.fields_by_name['proto_data'])
_NUMPYPROTO.fields_by_name['proto_data'].containing_oneof = _NUMPYPROTO.oneofs_by_name['data']
DESCRIPTOR.message_types_by_name['NumpyProto'] = _NUMPYPROTO
_sym_db.RegisterFileDescriptor(DESCRIPTOR)

NumpyProto = _reflection.GeneratedProtocolMessageType('NumpyProto', (_message.Message,), {
