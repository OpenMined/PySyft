...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  ,
  dependencies=[proto_dot_lib_dot_petlib_dot_bn__pb2.DESCRIPTOR,proto_dot_lib_dot_python_dot_tuple__pb2.DESCRIPTOR,])
...
_NIZK = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='challenge', full_name='syft.lib.zksk.NIZK.challenge', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='responses', full_name='syft.lib.zksk.NIZK.responses', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='stmt_hash', full_name='syft.lib.zksk.NIZK.stmt_hash', index=2,
...
_NIZK.fields_by_name['challenge'].message_type = proto_dot_lib_dot_petlib_dot_bn__pb2._BN
_NIZK.fields_by_name['responses'].message_type = proto_dot_lib_dot_python_dot_tuple__pb2._TUPLE
DESCRIPTOR.message_types_by_name['NIZK'] = _NIZK
_sym_db.RegisterFileDescriptor(DESCRIPTOR)

NIZK = _reflection.GeneratedProtocolMessageType('NIZK', (_message.Message,), {
  'DESCRIPTOR' : _NIZK,
