...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  serialized_pb=b'\n/proto/lib/python/collections/ordered_dict.proto\x12\x1bsyft.lib.python.collections\x1a\'proto/core/common/recursive_serde.proto\"Y\n\x0bOrderedDict\x12\x0c\n\x04keys\x18\x01 \x03(\x0c\x12\x0e\n\x06values\x18\x02 \x03(\x0c\x12,\n\x02id\x18\x03 \x01(\x0b\x32 .syft.core.common.RecursiveSerdeb\x06proto3'
  ,
...
_ORDEREDDICT = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='keys', full_name='syft.lib.python.collections.OrderedDict.keys', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='values', full_name='syft.lib.python.collections.OrderedDict.values', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='id', full_name='syft.lib.python.collections.OrderedDict.id', index=2,
...
_ORDEREDDICT.fields_by_name['id'].message_type = proto_dot_core_dot_common_dot_recursive__serde__pb2._RECURSIVESERDE
DESCRIPTOR.message_types_by_name['OrderedDict'] = _ORDEREDDICT
_sym_db.RegisterFileDescriptor(DESCRIPTOR)

OrderedDict = _reflection.GeneratedProtocolMessageType('OrderedDict', (_message.Message,), {
