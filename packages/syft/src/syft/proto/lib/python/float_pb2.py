...
_FLOAT = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='data', full_name='syft.lib.python.Float.data', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='id', full_name='syft.lib.python.Float.id', index=1,
...
_FLOAT.fields_by_name['id'].message_type = proto_dot_core_dot_common_dot_recursive__serde__pb2._RECURSIVESERDE
