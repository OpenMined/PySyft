...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  serialized_pb=b'\n\x1bproto/lib/python/dict.proto\x12\x0fsyft.lib.python\x1a\'proto/core/common/recursive_serde.proto\"i\n\x04\x44ict\x12\x0c\n\x04keys\x18\x01 \x03(\x0c\x12\x0e\n\x06values\x18\x02 \x03(\x0c\x12,\n\x02id\x18\x03 \x01(\x0b\x32 .syft.core.common.RecursiveSerde\x12\x15\n\rtemporary_box\x18\x04 \x01(\x08\x62\x06proto3'
  ,
...
_DICT = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='keys', full_name='syft.lib.python.Dict.keys', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='values', full_name='syft.lib.python.Dict.values', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='id', full_name='syft.lib.python.Dict.id', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='temporary_box', full_name='syft.lib.python.Dict.temporary_box', index=3,
...
_DICT.fields_by_name['id'].message_type = proto_dot_core_dot_common_dot_recursive__serde__pb2._RECURSIVESERDE
