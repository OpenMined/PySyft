...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  serialized_pb=b'\n\x1fproto/lib/python/iterator.proto\x12\x0fsyft.lib.python\x1a\'proto/core/common/recursive_serde.proto\"|\n\x08Iterator\x12,\n\x02id\x18\x01 \x01(\x0b\x32 .syft.core.common.RecursiveSerde\x12\x0f\n\x07obj_ref\x18\x02 \x01(\x0c\x12\r\n\x05index\x18\x03 \x01(\x05\x12\x0f\n\x07max_len\x18\x04 \x01(\x05\x12\x11\n\texhausted\x18\x05 \x01(\x08\x62\x06proto3'
  ,
...
_ITERATOR = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='id', full_name='syft.lib.python.Iterator.id', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='obj_ref', full_name='syft.lib.python.Iterator.obj_ref', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='index', full_name='syft.lib.python.Iterator.index', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='max_len', full_name='syft.lib.python.Iterator.max_len', index=3,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='exhausted', full_name='syft.lib.python.Iterator.exhausted', index=4,
...
_ITERATOR.fields_by_name['id'].message_type = proto_dot_core_dot_common_dot_recursive__serde__pb2._RECURSIVESERDE
