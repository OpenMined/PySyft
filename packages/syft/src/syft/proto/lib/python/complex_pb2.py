...
_COMPLEX = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='real', full_name='syft.lib.python.Complex.real', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='imag', full_name='syft.lib.python.Complex.imag', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='id', full_name='syft.lib.python.Complex.id', index=2,
...
_COMPLEX.fields_by_name['id'].message_type = proto_dot_core_dot_common_dot_recursive__serde__pb2._RECURSIVESERDE
