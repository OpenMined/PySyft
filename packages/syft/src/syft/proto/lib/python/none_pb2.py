...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  serialized_pb=b'\n\x1bproto/lib/python/none.proto\x12\x0fsyft.lib.python\x1a\'proto/core/common/recursive_serde.proto\"M\n\x06SyNone\x12,\n\x02id\x18\x01 \x01(\x0b\x32 .syft.core.common.RecursiveSerde\x12\x15\n\rtemporary_box\x18\x02 \x01(\x08\x62\x06proto3'
  ,
...
_SYNONE = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='id', full_name='syft.lib.python.SyNone.id', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='temporary_box', full_name='syft.lib.python.SyNone.temporary_box', index=1,
...
_SYNONE.fields_by_name['id'].message_type = proto_dot_core_dot_common_dot_recursive__serde__pb2._RECURSIVESERDE
DESCRIPTOR.message_types_by_name['SyNone'] = _SYNONE
_sym_db.RegisterFileDescriptor(DESCRIPTOR)

SyNone = _reflection.GeneratedProtocolMessageType('SyNone', (_message.Message,), {
  'DESCRIPTOR' : _SYNONE,
