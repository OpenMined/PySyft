    ...
    def _user_code_execute(
        ...
        try:
            if not has_twin_inputs:
                ...
                exec_result = execute_byte_code(code_item, filtered_kwargs, logger).result
                ...
                private_exec_result = execute_byte_code(code_item, private_kwargs, logger).result
                ...
                mock_exec_result = execute_byte_code(code_item, mock_kwargs, logger).result
