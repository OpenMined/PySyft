...
def get_args():
    ...
    parser.add_argument(
        ...
        type=int,
        default=50,
        help="the number of total epochs to run; default: 50",
    )
    parser.add_argument(
    ...
    parser.add_argument(
        ...
        type=int,
        default=100,
        help="the size of each embedding vector; default: 100",
    )
    parser.add_argument(
        "--d_proj",
        type=int,
        default=300,
        help="the size of each projection layer; default: 300",
    )
    parser.add_argument(
        "--d_hidden",
        type=int,
        default=300,
        help="the number of features in the hidden state; default: 300",
    )
    parser.add_argument(
        "--n_layers",
        type=int,
    ...
    parser.add_argument(
        ...
        type=int,
        default=50,
        help="iteration period to output log; default: 50",
    )
    parser.add_argument(
    ...
    parser.add_argument(
        ...
        type=int,
        default=1000,
        help="log period of validation results; default: 1000",
    )
    parser.add_argument(
        "--save_every",
        type=int,
        default=1000,
        help="model checkpoint period; default: 1000",
    )
    parser.add_argument(
        "--dp_ratio",
        type=int,
        default=0.2,
        help="probability of an element to be zeroed; default: 0.2",
    )
    parser.add_argument(
        "--no-bidirectional",
        action="store_false",
    ...
    parser.add_argument(
        ...
        type=str,
        default="results",
        help='save path of results; default: "results"',
    )
    parser.add_argument(
        "--vector_cache",
        type=str,
    ...
    parser.add_argument(
        ...
        type=str,
        default="",
        help='model snapshot to resume; default:""',
    )
    parser.add_argument(
        "--dry-run",
        action="store_true",
