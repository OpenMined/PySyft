...
def test_call_service_syftapi_with_permission(worker, guest_mock_user, update_user) -> None:
...
def test_call_service_syftapi_no_permission(guest_datasite_client) -> None:
    with pytest.raises(AttributeError):
        guest_datasite_client.api.services.user.get_all()


def test_directly_call_service_with_permission(worker, guest_mock_user, update_user) -> None:
...
def test_directly_call_service_no_permission(guest_datasite_client) -> None:
    api_call = SyftAPICall(
