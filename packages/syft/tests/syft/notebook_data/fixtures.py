...
def jane_client_credentials(client):
    ...
    response = client.register(name="Jane Doe", email="jane@caltech.edu", password="abc123", password_verify="abc123", institution="Caltech", website="https://www.caltech.edu/")
...
def batman_credentials(node):
    ...
    response = node.register(email="batman@gotham.com", password="1rIzHAx6uQaP",password_verify="1rIzHAx6uQaP", name="Batman")
...
def robin_credentials(node):
    ...
    response = node.register(email="robin@gotham.com", password="5v1ei4OM2N4m",password_verify="5v1ei4OM2N4m", name="Robin")
...
def joker_credentials(client):
    ...
    response = client.register(email="joker@gotham.com", password="joker123", password_verify="joker123", name="Joker")
...
def bane_credentials(node):
    ...
    response = node.register(email="bane@gotham.com", password="SKY5cC2zQPRP",password_verify="SKY5cC2zQPRP", name="Bane")
...
def riddler_credentials():
    ...
    response = node.register(email="riddler@gotham.com", password="7eVGUuNDyH8P",password_verify="7eVGUuNDyH8P", name="Riddler")
