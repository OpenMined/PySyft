...
export declare class KVIterable extends __S {
  ...
  adoptKeys(value: capnp.Orphan<capnp.List<capnp.Data>>): void;
  disownKeys(): capnp.Orphan<capnp.List<capnp.Data>>;
  getKeys(): capnp.List<capnp.Data>;
  hasKeys(): boolean;
  initKeys(length: number): capnp.List<capnp.Data>;
  setKeys(value: capnp.List<capnp.Data>): void;
